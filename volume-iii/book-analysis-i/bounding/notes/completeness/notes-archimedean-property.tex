...
\[
\operatorname{HasArchimedeanProperty}(\mathbb{R})\Longleftrightarrow
\forall x\in\mathbb{R}\;\exists n\in\mathbb{N}\;(n>x).
\]
\end{remark*}
...
\[
\neg\operatorname{HasArchimedeanProperty}(\mathbb{R})\Longleftrightarrow
\exists x\in\mathbb{R}\;\forall n\in\mathbb{N}\;(n\le x).
\]
\end{remark*}
...
\begin{remark*}[Predicate reading]
\[
\operatorname{HasArchimedeanProperty}(\mathbb{R})
\Longrightarrow
