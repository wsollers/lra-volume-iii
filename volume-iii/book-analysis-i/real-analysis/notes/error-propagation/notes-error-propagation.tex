...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:absolute-error-approximation}{lra-lean}{LRA.VolumeIII.Analysis.RealAnalysis.ErrorPropagation}{AbsoluteError}{pending}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:absolute-error-sum}{lra-lean}{LRA.VolumeIII.Analysis.RealAnalysis.ErrorPropagation}{AbsoluteErrorSum}{pending}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:absolute-error-product}{lra-lean}{LRA.VolumeIII.Analysis.RealAnalysis.ErrorPropagation}{AbsoluteErrorProduct}{pending}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:absolute-error-quotient}{lra-lean}{LRA.VolumeIII.Analysis.RealAnalysis.ErrorPropagation}{AbsoluteErrorQuotient}{pending}
...
\end{proposition}
\end{propositionbox}
\LeanFormalizes{prop:relative-error-product}{lra-lean}{LRA.VolumeIII.Analysis.RealAnalysis.ErrorPropagation}{RelativeErrorProduct}{pending}
...
\end{proposition}
\end{propositionbox}
\LeanFormalizes{prop:relative-error-quotient}{lra-lean}{LRA.VolumeIII.Analysis.RealAnalysis.ErrorPropagation}{RelativeErrorQuotient}{pending}
