...
\[
\operatorname{Partition}(P,I) \coloneqq
...
\[
\neg\operatorname{Partition}(P,I) \Longleftrightarrow
...
\begin{remark*}[Predicate reading]
\[
\operatorname{TaggedPartition}(\dot{\mathcal{P}},P,[a,b])
\coloneqq
...
\begin{remark*}[Negation predicate reading]
\[
\neg\operatorname{TaggedPartition}(\dot{\mathcal{P}},P,[a,b])
\Longleftrightarrow
(x_0\ne a)\lor(x_n\ne b)\lor
...
\begin{remark*}[Predicate reading]
\[
\operatorname{IsDeltaFine}(\dot{\mathcal{P}},\delta) \coloneqq \forall i \in \{1,\dots,n\}\;\forall x \in [x_{i-1},x_i]\;( |x-t_i|<\delta(t_i)).
\]
\end{remark*}
...
\begin{remark*}[Negation predicate reading]
\[
\neg \operatorname{IsDeltaFine}(\dot{\mathcal{P}},\delta) \Longleftrightarrow \exists i \in \{1,\dots,n\}\;\exists x \in [x_{i-1},x_i]\;( |x-t_i|\ge \delta(t_i)).
\]
\end{remark*}
...
&\operatorname{TaggedPartition}(\dot{\mathcal{P}},P,[a,b])\\
&\land
\operatorname{IsDeltaFine}(\dot{\mathcal{P}},\delta)
\Bigr).
\end{aligned}
\]
\end{remark*}
...
\operatorname{TaggedPartition}(\dot{\mathcal{P}},P,[a,b])
\Rightarrow
\neg\operatorname{IsDeltaFine}(\dot{\mathcal{P}},\delta)
\Bigr).
\]
\end{remark*}
...
\operatorname{TaggedPartition}(\dot{\mathcal{P}},P,[a,b])}_{\text{all tagged partitions}}
\quad\Rightarrow\quad
\underbrace{\neg\operatorname{IsDeltaFine}(\dot{\mathcal{P}},\delta)}_{\text{some interval escapes its gauge ball}}.
\]
\end{description}
\end{remark*}
