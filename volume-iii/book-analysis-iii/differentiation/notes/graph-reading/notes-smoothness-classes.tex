...
\begin{definitionbox}{Example (Differentiable Everywhere, but Not \(C^1\))}
...
\[
  ...
  \neg\operatorname{ContinuousAt}(f^{(k)},x)\bigr].
\]
\end{remark*}

\begin{remark*}[Negation predicate reading]
\(\neg\operatorname{ClassC}(f,I,k)\): somewhere the \(k\)-th derivative
...
\input{volume-iii/book-analysis-iii/differentiation/notes/graph-reading/figure-lipschitz-derivative}
...
\[
  \operatorname{ClassC11}(f,I)
  \Longleftrightarrow
  \operatorname{ClassC}(f,I,1)\land
  \exists L\geq0:\operatorname{Lipschitz}(f',I,L).
\]
...
\input{volume-iii/book-analysis-iii/differentiation/notes/graph-reading/figure-c11-descent-bounds}
...
\[
  ...
  \Rightarrow
  f\in C^{1,1}(I)\land \operatorname{Lipschitz}(f',I,M).
\]
\end{remark*}
