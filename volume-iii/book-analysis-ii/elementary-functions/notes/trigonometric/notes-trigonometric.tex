...
\[
  \operatorname{TendsTo}\!\left(\frac{\sin x}{x},\,0,\,1\right)
  \;\colonequiv\;
  ...
  \bigl(
    ...
    \wedge
    \operatorname{Within}\!\left(\frac{\sin x}{x},B_\varepsilon(1),\mathbb R\right)
  \bigr).
\]
\end{remark*}
...
\begin{remark*}[Predicate reading]
\[
  \operatorname{TendsTo}\!\left(\frac{1-\cos x}{x^2},\,0,\,\tfrac{1}{2}\right)
  \;\colonequiv\;
  \forall\varepsilon>0,\;\exists\delta>0,\;\forall x:\;
  \bigl(
    \operatorname{PuncturedNeighborhood}(U^\times_\delta,U_\delta,0,\delta,\mathbb R)
  ...
  \Rightarrow
  \bigl(
    \operatorname{Ball}(B_\varepsilon(\tfrac{1}{2}),\tfrac{1}{2},\varepsilon,\mathbb R)
    \wedge
    \operatorname{Within}\!\left(\frac{1-\cos x}{x^2},B_\varepsilon(\tfrac{1}{2}),\mathbb R\right)
  \bigr).
\]
\end{remark*}
