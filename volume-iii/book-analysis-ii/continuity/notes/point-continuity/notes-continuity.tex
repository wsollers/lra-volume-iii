...
\begin{remark*}[Predicate reading]
\[
\operatorname{IsContinuous}(f,A,c)
\coloneqq
\forall \varepsilon>0\;\exists \delta>0\;\forall x\in A\;
\bigl(|x-c|<\delta \Rightarrow |f(x)-f(c)|<\varepsilon\bigr).
\]
...
\begin{remark*}[Negation predicate reading]
\[
\neg\operatorname{IsContinuous}(f,A,c)
\Longleftrightarrow
\exists \varepsilon_0>0\;\forall \delta>0\;\exists x\in A\;
\bigl(|x-c|<\delta \land |f(x)-f(c)| \ge \varepsilon_0\bigr).
\]
...
\begin{remark*}[Predicate reading]
\[
\operatorname{IsContinuous}(f,c) \coloneqq \forall \varepsilon > 0\; \exists \delta > 0:\; f\bigl(A \cap (c-\delta, c+\delta)\bigr) \subseteq (f(c)-\varepsilon, f(c)+\varepsilon).
\]
\end{remark*}
...
\begin{remark*}[Negation predicate reading]
\[
\operatorname{IsDiscontinuous}(f,c) \Longleftrightarrow \exists \varepsilon_{0} > 0\; \forall \delta > 0:\; f\bigl(A \cap (c-\delta, c+\delta)\bigr) \nsubseteq (f(c)-\varepsilon_{0}, f(c)+\varepsilon_{0}).
\]
\end{remark*}
...
\begin{remark*}[Predicate reading]
\[
\operatorname{IsContinuous}(f,c) \coloneqq
\forall x_n\;
\Bigl(\mathsf{Sequence}(x_n, A) \land \operatorname{ConvergesTo}(x_n, c)
\Rightarrow \operatorname{ConvergesTo}(f(x_n), f(c))\Bigr).
\]
\end{remark*}
...
\begin{remark*}[Negation predicate reading]
\[
\neg\operatorname{IsContinuous}(f,c) \Longleftrightarrow
\exists x_n\;
\Bigl(\mathsf{Sequence}(x_n, A) \land \operatorname{ConvergesTo}(x_n, c)
\land \neg\operatorname{ConvergesTo}(f(x_n), f(c))\Bigr).
\]
\end{remark*}
