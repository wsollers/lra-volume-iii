...
\operatorname{IsConstant}(x_n,c)
\Longrightarrow
\bigl(\operatorname{IsNull}(x_n) \Longleftrightarrow c = 0\bigr).
\]
\end{remark*}
...
\begin{remark*}[Predicate reading]
\[
\operatorname{IsUltimatelyConstant}(x_n,c)
\coloneqq
\exists N \in \mathbb{N}\;
\forall n \ge N\;(x_n = c).
\]
...
\begin{remark*}[Predicate reading]
\[
\operatorname{IsUltimatelyConstant}(x_n,0)
\Longrightarrow
\operatorname{IsNull}(x_n).
\]
\end{remark*}
...
\operatorname{ConvergesTo}(x_n,L)
\Longleftrightarrow
\operatorname{ConvergesTo}(y_n,L)
\bigr).
\]
\end{remark*}
