...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:cauchy-sequence}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Cauchy}{IsCauchy}{pending}
...
\[
\operatorname{IsCauchy}(x_n,\mathbb{R})
\coloneqq
\forall \varepsilon>0 \;\exists N\in\mathbb{N}\;\forall m,n\ge N
\;\bigl(|x_m-x_n|<\varepsilon\bigr).
\]
...
\[
\neg\operatorname{IsCauchy}(x_n,\mathbb{R})
\Longleftrightarrow
\exists \varepsilon>0 \;\forall N\in\mathbb{N}\;\exists m,n\ge N
\;\bigl(|x_m-x_n|\ge\varepsilon\bigr).
\]
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:convergent-sequences-are-cauchy}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Cauchy}{ConvergentSequencesAreCauchy}{pending}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:cauchy-sequences-are-bounded}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Cauchy}{CauchySequencesAreBounded}{pending}
...
\label{thm:cauchy-convergent-subsequence-converges}
Let $(x_n)$ be a Cauchy real sequence. If a subsequence of $(x_n)$
converges to $L\in\mathbb{R}$, then $(x_n)$ converges to $L$.

\smallskip
\noindent
\hyperref[prf:cauchy-convergent-subsequence-converges]{\textit{Go to proof.}}
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:cauchy-convergent-subsequence-converges}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Cauchy}{CauchyConvergentSubsequenceConverges}{pending}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:cauchy-criterion-real-sequences}{lra-lean}{LRA.VolumeIII.Analysis.Completeness.CompletenessEquivalences}{StandardCompletenessEquivalences}{pending}
\LeanFormalizes{thm:cauchy-criterion-real-sequences}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Cauchy}{CauchyCriterionRealSequences}{pending}
...
\begin{itemize}
  ...
  \item \hyperref[thm:cauchy-convergent-subsequence-converges]{Cauchy Sequence with a Convergent Subsequence}
\end{itemize}
\end{dependencies}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:cauchy-criterion-via-tails}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Cauchy}{CauchyCriterionViaTails}{pending}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:cauchy-tail-diameter-criterion}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Cauchy}{CauchyTailDiameterCriterion}{pending}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:cauchy-successive-differences-vanish}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Cauchy}{CauchySuccessiveDifferencesVanish}{pending}
...
\operatorname{IsCauchy}(x_n,\mathbb{R})
\Longrightarrow
\operatorname{IsNull}\bigl(|x_{n+1}-x_n|,\mathbb{R}\bigr).
\]
\end{remark*}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:scalar-multiple-cauchy-sequence}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Cauchy}{ScalarMultipleCauchySequence}{pending}
...
\operatorname{IsCauchy}(x_n,\mathbb{R})
\Longrightarrow
\operatorname{IsCauchy}(\alpha x_n,\mathbb{R}).
\]
\end{remark*}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:sum-cauchy-sequences}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Cauchy}{SumCauchySequences}{pending}
...
\operatorname{IsCauchy}(x_n,\mathbb{R})
\land
\operatorname{IsCauchy}(y_n,\mathbb{R})
\Longrightarrow
\operatorname{IsCauchy}(x_n+y_n,\mathbb{R}).
\]
\end{remark*}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:difference-cauchy-sequences}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Cauchy}{DifferenceCauchySequences}{pending}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:linear-combination-cauchy-sequences}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Cauchy}{LinearCombinationCauchySequences}{pending}
...
\operatorname{IsCauchy}(y_n,\mathbb{R})
\Longrightarrow
\operatorname{IsCauchy}(\alpha x_n+\beta y_n,\mathbb{R}).
\]
\end{remark*}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:product-cauchy-sequences}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Cauchy}{ProductCauchySequences}{pending}
...
\operatorname{IsCauchy}(y_n,\mathbb{R})
\Longrightarrow
\operatorname{IsCauchy}(x_ny_n,\mathbb{R}).
\]
\end{remark*}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:reciprocal-cauchy-sequence}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Cauchy}{ReciprocalCauchySequence}{pending}
...
\exists c>0\;\exists N_0\in\mathbb{N}\;\forall n\ge N_0\;( |x_n|\ge c )
\Longrightarrow
\operatorname{IsCauchy}(1/x_n,\mathbb{R}).
\]
\end{remark*}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:quotient-cauchy-sequences}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Cauchy}{QuotientCauchySequences}{pending}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:absolute-value-cauchy-sequence}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Cauchy}{AbsoluteValueCauchySequence}{pending}
