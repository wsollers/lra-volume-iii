...
% File: volume-iii/algebra/algebraic-structures/notes/notes-number-systems-as-structures.tex
%
...
\section{The Number Systems as $\mathcal{L}$-Structures}
...
\begin{tcolorbox}[colback=axiombox, colframe=axiomborder, arc=2pt,
  ...
  title={\small\textbf{The Arithmetic Signature $\mathcal{L}_{\mathrm{arith}}$}},
