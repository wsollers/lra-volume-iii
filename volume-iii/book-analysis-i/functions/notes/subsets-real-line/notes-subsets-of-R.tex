...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:epsilon-neighbourhood}{lra-lean}{LRA.VolumeIII.Analysis.Functions.SubsetsOfR}{CenteredOpenInterval}{pending}
...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:deleted-epsilon-neighbourhood}{lra-lean}{LRA.VolumeIII.Analysis.Functions.SubsetsOfR}{PuncturedCenteredOpenInterval}{pending}
...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:cluster-point-r}{lra-lean}{LRA.VolumeIII.Analysis.Functions.SubsetsOfR}{IsClusterPointR}{pending}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:cluster-point-sequential}{lra-lean}{LRA.VolumeIII.Analysis.Functions.SubsetsOfR}{ClusterPointSequential}{pending}
...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:adherent-point-r}{lra-lean}{LRA.VolumeIII.Analysis.Functions.SubsetsOfR}{IsAdherentPointR}{pending}
...
\begin{remark*}[Predicate reading]
\[
  \operatorname{IsAdherent}(x,X,\mathbb{R})
  \;\coloneqq\;
  \forall\varepsilon>0\;\exists y\in X\;(|y-x|<\varepsilon).
\]
\end{remark*}
...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:isolated-point-r}{lra-lean}{LRA.VolumeIII.Analysis.Functions.SubsetsOfR}{IsIsolatedPointR}{pending}
...
\begin{remark*}[Predicate reading]
\[
  \operatorname{IsIsolated}(x,X,\mathbb{R})
  \;\coloneqq\;
...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:interior-point-r}{lra-lean}{LRA.VolumeIII.Analysis.Functions.SubsetsOfR}{IsInteriorPointR}{pending}
...
\begin{remark*}[Predicate reading]
\[
  \operatorname{IsInterior}(x,X,\mathbb{R})\;\coloneqq\;\exists\varepsilon>0\;\bigl(I_\varepsilon(x)\subseteq X\bigr).
\]
\end{remark*}
...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:boundary-point-r}{lra-lean}{LRA.VolumeIII.Analysis.Functions.SubsetsOfR}{IsBoundaryPointR}{pending}
...
\begin{remark*}[Predicate reading]
\[
  \operatorname{IsOnBoundary}(x,X,\mathbb{R})\;\coloneqq\;
  \forall\varepsilon>0\;\bigl(I_\varepsilon(x)\cap X\neq\emptyset\bigr)
  \wedge\bigl(I_\varepsilon(x)\cap X^c\neq\emptyset\bigr).
\]
\end{remark*}
...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:interior-r}{lra-lean}{LRA.VolumeIII.Analysis.Functions.SubsetsOfR}{InteriorR}{pending}
...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:boundary-r}{lra-lean}{LRA.VolumeIII.Analysis.Functions.SubsetsOfR}{BoundaryR}{pending}
...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:closure-r}{lra-lean}{LRA.VolumeIII.Analysis.Functions.SubsetsOfR}{ClosureR}{pending}
...
\end{proposition}
\end{propositionbox}
\LeanFormalizes{prop:adherent-points-are-closure-points}{lra-lean}{LRA.VolumeIII.Analysis.Functions.SubsetsOfR}{AdherentPointsAreClosurePoints}{pending}
...
\end{proposition}
\end{propositionbox}
\LeanFormalizes{prop:isolated-points-are-noncluster-adherent-points}{lra-lean}{LRA.VolumeIII.Analysis.Functions.SubsetsOfR}{IsolatedPointsAreNonclusterAdherentPoints}{pending}

\begin{remark*}[Standard quantified statement]
\[
  x\in X
  \;\Longrightarrow\;
  \bigl(\operatorname{IsIsolated}(x,X,\mathbb{R})
  \Longleftrightarrow
  \operatorname{IsAdherent}(x,X,\mathbb{R})\wedge\neg\operatorname{IsCluster}(x,X)\bigr).
\]
\end{remark*}
...
\end{proposition}
\end{propositionbox}
\LeanFormalizes{prop:interior-membership-characterization}{lra-lean}{LRA.VolumeIII.Analysis.Functions.SubsetsOfR}{InteriorMembershipCharacterization}{pending}
...
\end{proposition}
\end{propositionbox}
\LeanFormalizes{prop:interior-is-contained-in-set}{lra-lean}{LRA.VolumeIII.Analysis.Functions.SubsetsOfR}{InteriorIsContainedInSet}{pending}
...
\end{proposition}
\end{propositionbox}
\LeanFormalizes{prop:closure-is-smallest-closed-superset}{lra-lean}{LRA.VolumeIII.Analysis.Functions.SubsetsOfR}{ClosureIsSmallestClosedSuperset}{pending}
...
\end{proposition}
\end{propositionbox}
\LeanFormalizes{prop:boundary-as-closure-minus-interior}{lra-lean}{LRA.VolumeIII.Analysis.Functions.SubsetsOfR}{BoundaryAsClosureMinusInterior}{pending}
...
\end{lemma}
\end{lemmabox}
\LeanFormalizes{lem:closure-elementary}{lra-lean}{LRA.VolumeIII.Analysis.Functions.SubsetsOfR}{ClosureElementary}{pending}
...
\end{corollary}
\end{corollarybox}
\LeanFormalizes{cor:closed-iff-seq-limits}{lra-lean}{LRA.VolumeIII.Analysis.Functions.SubsetsOfR}{ClosedIffSeqLimits}{pending}
...
\end{corollary}
\end{corollarybox}
\LeanFormalizes{cor:interval-all-limit-points}{lra-lean}{LRA.VolumeIII.Analysis.Functions.SubsetsOfR}{IntervalAllLimitPoints}{pending}
...
\begin{remark*}[Predicate reading]
\[
  \operatorname{IsCluster}(x,I,\mathbb{R})
  \;\Longleftrightarrow\;
  \forall\varepsilon>0\;\exists y\in I\setminus\{x\}\;(|y-x|<\varepsilon).
\]
\end{remark*}
...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:bounded-set-r}{lra-lean}{LRA.VolumeIII.Analysis.Functions.SubsetsOfR}{IsBoundedSetR}{pending}
...
\begin{remark*}[Predicate reading]
\[
  \operatorname{Bounded}(X,\mathsf{OrderedSet}(\mathbb{R},\leq))
  \;\Longleftrightarrow\;
  \exists M>0\;\forall x\in X\;(|x|\leq M).
\]
\end{remark*}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:heine-borel-subsets-real-line}{lra-lean}{LRA.VolumeIII.Analysis.Functions.SubsetsOfR}{HeineBorelSubsetsRealLine}{pending}
...
\begin{remark*}[Predicate reading]
\[
  \operatorname{IsSequentiallyCompact}(X,\mathbb{R})
  \;\colonequiv\;
  X\text{ is closed} \wedge X\text{ is bounded}.
\]
\end{remark*}
...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:true-near}{lra-lean}{LRA.VolumeIII.Analysis.Functions.SubsetsOfR}{TrueNear}{pending}
...
\end{proposition}
\end{propositionbox}
\LeanFormalizes{prop:true-near-stable-under-shrinking}{lra-lean}{LRA.VolumeIII.Analysis.Functions.SubsetsOfR}{TrueNearStableUnderShrinking}{pending}
...
\end{proposition}
\end{propositionbox}
\LeanFormalizes{prop:true-near-stable-under-conjunction}{lra-lean}{LRA.VolumeIII.Analysis.Functions.SubsetsOfR}{TrueNearStableUnderConjunction}{pending}
...
% Lean-aligned addition: thm:open-iff-complement-closed
\begin{theorem}[Open Sets and Closed Complements]
\label{thm:open-iff-complement-closed}
A set $U\subseteq\mathbb R$ is open if and only if its complement $\mathbb R\setminus U$ is closed.

\smallskip
\noindent
\hyperref[prf:open-iff-complement-closed]{\textit{Go to proof.}}
\end{theorem}
\LeanFormalizes{thm:open-iff-complement-closed}{lra-lean}{LRA.VolumeIII.Analysis.Functions.SubsetsOfR}{OpenIffComplementClosed}{pending}
