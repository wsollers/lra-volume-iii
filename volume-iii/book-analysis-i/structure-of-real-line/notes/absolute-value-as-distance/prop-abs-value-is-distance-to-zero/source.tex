...
\end{proposition}
\end{propositionbox}
\LeanFormalizes{prop:abs-value-is-distance-to-zero}{lra-lean}{LRA.VolumeIII.Analysis.StructureOfRealLine.OrderDistanceIntervals}{AbsIsDistanceToZero}{pending}
