...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:first-order-approximation-at-a-point}{lra-lean}{LRA.VolumeIII.Analysis.Differentiation.LinearApproximation}{HasLinearApproximation}{pending}
...
\begin{remark*}[Standard quantified statement]
\[
\operatorname{IsDifferentiable}(f,a,\mathbb{R},\mathbb{R})
\Longleftrightarrow
...
The predicate $\operatorname{IsDifferentiable}(f,a,\mathbb{R},\mathbb{R})$ can be read as the
...
\begin{remark*}[Standard quantified statement]
\[
\operatorname{Derivative}(L,f,a,\mathbb{R},\mathbb{R})
\Longleftrightarrow
...
% Lean-aligned addition: thm:linear-approximation-slope-eq-derivative
\begin{theorem}[Linear Approximation Slope Equals the Derivative]
\label{thm:linear-approximation-slope-eq-derivative}
If $f(x)=f(c)+m(x-c)+o(x-c)$ as $x\to c$, then $f$ is differentiable at $c$ and $f'(c)=m$.

\smallskip
\noindent
\hyperref[prf:linear-approximation-slope-eq-derivative]{\textit{Go to proof.}}
\end{theorem}
\LeanFormalizes{thm:linear-approximation-slope-eq-derivative}{lra-lean}{LRA.VolumeIII.Analysis.Differentiation.LinearApproximation}{LinearApproximationSlopeEqDerivative}{pending}
