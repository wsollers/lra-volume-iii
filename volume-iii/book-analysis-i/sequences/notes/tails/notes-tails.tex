...
\begin{remark*}[Predicate reading]
\[
\Bigl(\exists L\in\mathbb{R}\,\operatorname{ConvergesTo}(x_n,L)\Bigr)
\Longleftrightarrow
\Bigl(\exists L\in\mathbb{R}\,\operatorname{ConvergesTo}(x_{m+n},L)\Bigr).
\]
\end{remark*}
...
\[
\bigl(
\operatorname{ConvergesTo}\bigl(x_{n+1}/x_n,L\bigr)
\land
L<1
\bigr)
\Longrightarrow
...
L<1
\land
\neg\operatorname{ConvergesTo}(x_n,0).
\]
\end{remark*}
