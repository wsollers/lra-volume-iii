...
\begin{definitionbox}{Definition (Oscillation on a Set)}
...
\operatorname{Oscillation}(\omega,f,E,\mathbb{R})
\coloneqq
\omega=\sup\{\,|f(x_1)-f(x_2)|:x_1,x_2\in E\,\}.
\end{aligned}
\]
...
\begin{aligned}
  f\colon A\to\mathbb{R},\\
\neg\operatorname{Oscillation}(\omega,f,E,\mathbb{R})
\Longleftrightarrow
\omega\ne\sup\{\,|f(x_1)-f(x_2)|:x_1,x_2\in E\,\}.
\end{aligned}
\]
...
\begin{definitionbox}{Definition (Oscillation at a Point)}
...
\begin{aligned}
  f\colon A\to\mathbb{R},\\
\operatorname{Oscillation}(\omega,f,x_0,\mathbb{R}) \coloneqq
...
\begin{aligned}
  f\colon A\to\mathbb{R},\\
\neg\operatorname{Oscillation}(\omega,f,x_0,\mathbb{R})
\Longleftrightarrow
\Bigl[\exists \delta_0>0:\, U_{\delta_0}(x_0)\cap E = \varnothing\Bigr]
\lor
\Bigl(\exists \varepsilon_0>0\; \forall \delta>0\; \exists r\;(0<r<\delta \land |\omega(f;U_r(x_0)\cap E)-\omega| \ge \varepsilon_0)\Bigr).
...
\begin{theorembox}{Theorem (Continuity Characterised by Oscillation)}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:continuity-iff-zero-oscillation}{lra-lean}{LRA.VolumeIII.Analysis.Continuity.PointContinuity}{ContinuousAtPointIffZeroOscillation}{pending}
...
\begin{aligned}
  f\colon A\to\mathbb{R},\\
\operatorname{IsContinuous}(f,c,\mathbb{R},\mathbb{R}) \Longleftrightarrow \operatorname{Oscillation}(0,f,c,\mathbb{R}).
\end{aligned}
\]
\end{remark*}
...
\begin{aligned}
  f\colon A\to\mathbb{R},\\
\neg\bigl(\operatorname{IsContinuous}(f,c,\mathbb{R},\mathbb{R}) \Longleftrightarrow \operatorname{Oscillation}(0,f,c,\mathbb{R})\bigr).
\end{aligned}
\]
\end{remark*}
...
\begin{description}
  \item[Exposition.]
\[
\underbrace{\operatorname{IsContinuous}(f,c,\mathbb{R},\mathbb{R}) \land \neg \operatorname{Oscillation}(0,f,c,\mathbb{R})}_{\text{Positive oscillation despite continuity}}
\;\lor\;
\underbrace{\neg \operatorname{IsContinuous}(f,c,\mathbb{R},\mathbb{R}) \land \operatorname{Oscillation}(0,f,c,\mathbb{R})}_{\text{Zero oscillation without continuity}}.
\]
...
\end{proposition}
\end{propositionbox}
\LeanFormalizes{prop:discontinuity-set-via-oscillation}{lra-lean}{LRA.VolumeIII.Analysis.Continuity.PointContinuity}{DiscontinuitySetEqUnionOscillationBounded}{pending}
...
&x\in D(f)
\Longleftrightarrow
\operatorname{IsDiscontinuous}(f,x,\mathbb{R},\mathbb{R})\\
&\Longleftrightarrow
\exists \omega\;(\operatorname{Oscillation}(f,x,\omega,\mathbb{R})\land \omega>0)\\
&\Longleftrightarrow
\exists n\in\mathbb{N}\;\exists \omega\;(\operatorname{Oscillation}(f,x,\omega,\mathbb{R})\land \omega\ge \tfrac1n).
\end{aligned}
\]
\end{remark*}
...
\begin{aligned}
  ...
  x\colon A\to\mathbb{R},\\
\exists x\in E\;\Bigl(
&\exists \omega\;(\operatorname{IsDiscontinuous}(f,x,\mathbb{R},\mathbb{R})\land \operatorname{Oscillation}(f,x,\omega,\mathbb{R})\land \omega=0)\;\lor\\
&\exists \omega\;(\neg\operatorname{IsDiscontinuous}(f,x,\mathbb{R},\mathbb{R})\land \operatorname{Oscillation}(f,x,\omega,\mathbb{R})\land \omega>0)\;\lor\\
&\exists \omega\;(\operatorname{Oscillation}(f,x,\omega,\mathbb{R})\land \omega>0\land \forall n\in\mathbb{N}\; \omega<\tfrac1n)
\Bigr).
\end{aligned}
\]
\end{remark*}
