...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:interior-point}{lra-lean}{LRA.VolumeIII.Analysis.StructureOfRealLine.OpenClosedSets}{IsInteriorPoint}{pending}
...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:exterior-point}{lra-lean}{LRA.VolumeIII.Analysis.StructureOfRealLine.OpenClosedSets}{IsExteriorPoint}{pending}
\begin{remark*}[Standard quantified statement]
\[
...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:boundary-point}{lra-lean}{LRA.VolumeIII.Analysis.StructureOfRealLine.OpenClosedSets}{IsBoundaryPoint}{pending}
\begin{remark*}[Standard quantified statement]
\[
...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:interior-of-set}{lra-lean}{LRA.VolumeIII.Analysis.StructureOfRealLine.OpenClosedSets}{Interior}{pending}
\begin{remark*}[Standard quantified statement]
\[
