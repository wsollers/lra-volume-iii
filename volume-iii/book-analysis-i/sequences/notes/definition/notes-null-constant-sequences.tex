...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:constant-sequence}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.NullConstantSequences}{IsConstant}{pending}
...
\[
\operatorname{IsConstant}(x_n,c,\mathbb{R})
\coloneqq
\forall n \in \mathbb{N}\;(x_n = c).
\]
\end{remark*}
...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:null-sequence}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.NullConstantSequences}{IsNull}{pending}
...
\begin{remark*}[Negation predicate reading]
\[
\neg\operatorname{IsNull}(x_n,\mathbb{R}).
\]
\end{remark*}
\begin{remark*}[Failure modes]
\begin{description}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:constant-sequence-convergence}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.NullConstantSequences}{ConstantSequenceConvergence}{pending}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:zero-sequence-is-null}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.NullConstantSequences}{ZeroSequenceIsNull}{pending}
...
\begin{remark*}[Predicate reading]
\[
\operatorname{IsConstant}(x_n,0,\mathbb{R})
\Longrightarrow
\operatorname{IsNull}(x_n,\mathbb{R}).
\]
\end{remark*}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:constant-null-sequence}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.NullConstantSequences}{ConstantNullSequence}{pending}
...
\operatorname{IsConstant}(x_n,c,\mathbb{R})
\Longrightarrow
\bigl(\operatorname{IsNull}(x_n,\mathbb{R}) \Longleftrightarrow c = 0\bigr).
\]
\end{remark*}
...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:ultimately-constant-sequence}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.NullConstantSequences}{IsUltimatelyConstant}{pending}
...
\begin{remark*}[Predicate reading]
\[
\operatorname{IsUltimatelyConstant}(x_n,c,\mathbb{R})
\coloneqq
\exists N \in \mathbb{N}\;
\forall n \ge N\;(x_n = c).
\]
...
\begin{description}
  \item[Exposition.]
Failure is witnessed by the negated condition displayed above.
  \item[\(\operatorname{IsUltimatelyConstant}.\)]
\[
\begin{aligned}
&\text{Let } (x_n) \text{ be a real sequence.}\\
&(x_n) \text{ is not ultimately constant}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:difference-from-limit-is-null}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.NullConstantSequences}{DifferenceFromLimitIsNull}{pending}
...
\Longleftrightarrow
\operatorname{IsNull}(x_n - L,\mathbb{R}).
\]
\end{remark*}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:ultimately-constant-sequence-convergence}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.NullConstantSequences}{UltimatelyConstantSequenceConvergence}{pending}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:constant-implies-ultimately-constant}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.NullConstantSequences}{ConstantImpliesUltimatelyConstant}{pending}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:ultimately-zero-sequence-is-null}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.NullConstantSequences}{UltimatelyZeroSequenceIsNull}{pending}
...
\begin{remark*}[Predicate reading]
\[
\operatorname{IsUltimatelyConstant}(x_n,0,\mathbb{R})
\Longrightarrow
\operatorname{IsNull}(x_n,\mathbb{R}).
\]
\end{remark*}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:ultimately-constant-null-sequence}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.NullConstantSequences}{UltimatelyConstantNullSequence}{pending}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:tail-equality-preserves-convergence}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.NullConstantSequences}{TailEqualityPreservesConvergence}{pending}
...
\begin{remark*}[Predicate reading]
\[
\operatorname{EventuallyEqual}(x_n,y_n,\mathbb{R})
\Longrightarrow
\forall L \in \mathbb{R}\;
\bigl(
\operatorname{ConvergesTo}(x_n,L,\mathbb{R})
\Longleftrightarrow
\operatorname{ConvergesTo}(y_n,L,\mathbb{R})
\bigr).
\]
\end{remark*}
...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:sequence-bounded-above}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.NullConstantSequences}{BoundedAboveSeq}{pending}
...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:sequence-bounded-below}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.NullConstantSequences}{BoundedBelowSeq}{pending}
...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:bounded-sequence}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.NullConstantSequences}{BoundedSeq}{pending}
...
\begin{remark*}[Negation predicate reading]
\[
\neg\operatorname{Bounded}(x_n,\mathbb{R}).
\]
\end{remark*}
\begin{remark*}[Failure modes]
\begin{description}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:eventually-bounded-above-tail-formulation}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.NullConstantSequences}{EventuallyBoundedAboveTailFormulation}{pending}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:eventually-bounded-below-tail-formulation}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.NullConstantSequences}{EventuallyBoundedBelowTailFormulation}{pending}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:eventually-bounded-tail-formulation}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.NullConstantSequences}{EventuallyBoundedTailFormulation}{pending}
...
\label{thm:bounded-sequence-bounded-above-below}
Let $(x_n)$ be a real sequence. The sequence $(x_n)$ is bounded if and only
if it is both bounded above and bounded below.

\smallskip
\noindent
\hyperref[prf:bounded-sequence-bounded-above-below]{\textit{Go to proof.}}
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:bounded-sequence-bounded-above-below}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.NullConstantSequences}{BoundedSequenceBoundedAboveBelow}{pending}
...
\label{thm:absolute-bound-upper-lower-bounds}
...
\smallskip
\noindent
\hyperref[prf:absolute-bound-upper-lower-bounds]{\textit{Go to proof.}}
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:absolute-bound-upper-lower-bounds}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.NullConstantSequences}{AbsoluteBoundUpperLowerBounds}{pending}
...
\label{thm:upper-lower-bounds-absolute-bound}
...
\smallskip
\noindent
\hyperref[prf:upper-lower-bounds-absolute-bound]{\textit{Go to proof.}}
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:upper-lower-bounds-absolute-bound}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.NullConstantSequences}{UpperLowerBoundsAbsoluteBound}{pending}
