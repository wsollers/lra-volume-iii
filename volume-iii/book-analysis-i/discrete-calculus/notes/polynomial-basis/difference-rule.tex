...
\subsection*{Consequences of the Difference Rule}
...
\subsection*{Higher Differences of Falling Factorials}
...
\subsection*{Connection to Binomial Coefficients}
...
\subsection*{\texorpdfstring{Worked Example: Expanding \(n^2\)}{Worked Example: Expanding n squared}}

\begin{example*}
The falling factorial expansion of \(f(n) = n^2\) is found as follows.
