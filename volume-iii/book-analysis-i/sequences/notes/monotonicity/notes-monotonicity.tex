...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:increasing-sequence}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Monotonicity}{IsIncreasing}{pending}
...
P=\mathsf{OrderedSet}(\mathbb{N},\leq),\quad
Q=\mathsf{OrderedSet}(\mathbb{R},\leq),\\
\neg\operatorname{OrderPreserving}(x_n,P,Q)
\Longleftrightarrow
\exists n\in\mathbb{N}\;(x_{n+1}<x_n).
\end{gathered}
\]
...
Failure is witnessed by the negated condition displayed above.
  \item[\(\operatorname{OrderPreserving}.\)]
\[
(x_n)\text{ is not increasing}
\Longleftrightarrow
\exists n\in\mathbb{N}\;(x_{n+1}<x_n).
...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:decreasing-sequence}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Monotonicity}{IsDecreasing}{pending}
...
P=\mathsf{OrderedSet}(\mathbb{N},\leq),\quad
Q=\mathsf{OrderedSet}(\mathbb{R},\leq),\\
\neg\operatorname{OrderReversing}(x_n,P,Q)
\Longleftrightarrow
\exists n\in\mathbb{N}\;(x_n<x_{n+1}).
\end{gathered}
\]
...
\begin{description}
  \item[Exposition.]
Failure is witnessed by the negated condition displayed above.
  \item[\(\operatorname{OrderReversing}.\)]
\[
(x_n)\text{ is not decreasing}
\Longleftrightarrow
\exists n\in\mathbb{N}\;(x_n<x_{n+1}).
...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:strictly-increasing-sequence}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Monotonicity}{IsStrictlyIncreasing}{pending}
...
P=\mathsf{OrderedSet}(\mathbb{N},\leq),\quad
Q=\mathsf{OrderedSet}(\mathbb{R},\leq),\\
\operatorname{StrictOrderPreserving}(x_n,P,Q)
\coloneqq
\forall n\in\mathbb{N}\;(x_n<x_{n+1}).
\end{gathered}
\]
...
P=\mathsf{OrderedSet}(\mathbb{N},\leq),\quad
Q=\mathsf{OrderedSet}(\mathbb{R},\leq),\\
\neg\operatorname{StrictOrderPreserving}(x_n,P,Q)
\Longleftrightarrow
\exists n\in\mathbb{N}\;(x_{n+1}\le x_n).
\end{gathered}
\]
...
\begin{description}
  \item[Exposition.]
Failure is witnessed by the negated condition displayed above.
  \item[\(\operatorname{StrictOrderPreserving}.\)]
\[
(x_n)\text{ is not strictly increasing}
\Longleftrightarrow
\exists n\in\mathbb{N}\;(x_{n+1}\le x_n).
...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:strictly-decreasing-sequence}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Monotonicity}{IsStrictlyDecreasing}{pending}
...
P=\mathsf{OrderedSet}(\mathbb{N},\leq),\quad
Q=\mathsf{OrderedSet}(\mathbb{R},\leq),\\
\operatorname{StrictOrderReversing}(x_n,P,Q)
\coloneqq
\forall n\in\mathbb{N}\;(x_{n+1}<x_n).
\end{gathered}
\]
...
P=\mathsf{OrderedSet}(\mathbb{N},\leq),\quad
Q=\mathsf{OrderedSet}(\mathbb{R},\leq),\\
\neg\operatorname{StrictOrderReversing}(x_n,P,Q)
\Longleftrightarrow
\exists n\in\mathbb{N}\;(x_n\le x_{n+1}).
\end{gathered}
\]
...
\begin{description}
  \item[Exposition.]
Failure is witnessed by the negated condition displayed above.
  \item[\(\operatorname{StrictOrderReversing}.\)]
\[
(x_n)\text{ is not strictly decreasing}
\Longleftrightarrow
\exists n\in\mathbb{N}\;(x_n\le x_{n+1}).
...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:monotone-sequence}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Monotonicity}{IsMonotoneSeq}{pending}
...
\[
\begin{aligned}
&P=\mathsf{OrderedSet}(\mathbb{N},\leq),\qquad
Q=\mathsf{OrderedSet}(\mathbb{R},\leq),\\
&\operatorname{Monotone}((x_n),Q)
\coloneqq
\operatorname{OrderPreserving}((x_n),P,Q)
\lor
\operatorname{OrderReversing}((x_n),P,Q).
...
&P=\mathsf{OrderedSet}(\mathbb{N},\leq),\qquad
Q=\mathsf{OrderedSet}(\mathbb{R},\leq),\\
&\neg\operatorname{Monotone}((x_n),Q)
\Longleftrightarrow
\neg\operatorname{OrderPreserving}((x_n),P,Q)
\land
\neg\operatorname{OrderReversing}((x_n),P,Q).
...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:eventually-increasing-sequence}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Monotonicity}{IsEventuallyIncreasing}{pending}
...
\[
\begin{aligned}
&P_N=\mathsf{OrderedSet}(\{n\in\mathbb{N}:n\ge N\},\leq),\qquad
Q=\mathsf{OrderedSet}(\mathbb{R},\leq),\\
&\varphi_{+}(N)\coloneqq
\operatorname{OrderPreserving}((x_n)_{n\ge N},P_N,Q),\\
&\operatorname{Eventually}(\varphi_{+},\mathbb{N}).
\end{aligned}
\]
\end{remark*}
...
&\varphi_{+}(N)\coloneqq
\operatorname{OrderPreserving}((x_n)_{n\ge N},P_N,Q),\\
&\neg\operatorname{Eventually}(\varphi_{+},\mathbb{N}).
\end{aligned}
\]
\end{remark*}
\begin{remark*}[Failure modes]
...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:eventually-decreasing-sequence}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Monotonicity}{IsEventuallyDecreasing}{pending}
...
Q=\mathsf{OrderedSet}(\mathbb{R},\leq),\\
&\varphi_{-}(N)\coloneqq
\operatorname{OrderReversing}((x_n)_{n\ge N},P_N,Q),\\
&\operatorname{Eventually}(\varphi_{-},\mathbb{N}).
\end{aligned}
\]
\end{remark*}
...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:eventually-monotone-sequence}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Monotonicity}{IsEventuallyMonotone}{pending}
...
\lor
\operatorname{OrderReversing}((x_n)_{n\ge N},P_N,Q),\\
&\operatorname{Eventually}(\varphi,\mathbb{N}).
\end{aligned}
\]
\end{remark*}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:monotone-convergence-theorem}{lra-lean}{LRA.VolumeIII.Analysis.Completeness.CompletenessEquivalences}{StandardCompletenessEquivalences}{pending}
\LeanFormalizes{thm:monotone-convergence-theorem}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Monotonicity}{MonotoneConvergenceTheoremDecreasing}{pending}
\LeanFormalizes{thm:monotone-convergence-theorem}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Monotonicity}{MonotoneConvergenceTheoremIncreasing}{pending}
...
\[
\begin{aligned}
&x_n\colon\mathbb{N}\to\mathbb{R},\quad
P=\mathsf{OrderedSet}(\mathbb{N},\leq),\quad
Q=\mathsf{OrderedSet}(\mathbb{R},\leq),\\
&\operatorname{OrderPreserving}(x_n,P,Q)
\land
...
\operatorname{BoundedAbove}(x_n,\mathbb{R})
\land
\neg\exists L\in\mathbb{R}\;\operatorname{ConvergesTo}(x_n,L,\mathbb{R}),\\
&\operatorname{OrderReversing}(x_n,P,Q)
\land
\operatorname{BoundedBelow}(x_n,\mathbb{R})
\land
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:strict-monotonicity-implies-monotonicity}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Monotonicity}{StrictDecreasingImpliesDecreasing}{pending}
\LeanFormalizes{thm:strict-monotonicity-implies-monotonicity}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Monotonicity}{StrictIncreasingImpliesIncreasing}{pending}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:bounded-monotone-sequence-equivalences}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Monotonicity}{BoundedMonotoneSequenceEquivalences}{pending}
\LeanFormalizes{thm:bounded-monotone-sequence-equivalences}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Monotonicity}{BoundedMonotoneSequenceEquivalencesDecr}{pending}
\LeanFormalizes{thm:bounded-monotone-sequence-equivalences}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Monotonicity}{BoundedMonotoneSequenceEquivalencesIncr}{pending}
...
\Longrightarrow
\Bigl(
\exists L\in\mathbb{R}\;\operatorname{ConvergesTo}(x_n,L,\mathbb{R})
\Longleftrightarrow
\operatorname{BoundedAbove}(x_n,\mathbb{R})
\Bigr),\\
&\operatorname{OrderReversing}(x_n,P,Q)
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:eventually-monotone-convergence-theorem}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Monotonicity}{EventuallyMonotoneConvergenceTheorem}{pending}
\LeanFormalizes{thm:eventually-monotone-convergence-theorem}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Monotonicity}{EventuallyMonotoneConvergenceTheoremDecr}{pending}
\LeanFormalizes{thm:eventually-monotone-convergence-theorem}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Monotonicity}{EventuallyMonotoneConvergenceTheoremIncr}{pending}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:unbounded-monotone-divergence}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Monotonicity}{UnboundedMonotoneDivergenceNeg}{pending}
\LeanFormalizes{thm:unbounded-monotone-divergence}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Monotonicity}{UnboundedMonotoneDivergencePos}{pending}
...
&\operatorname{OrderPreserving}(x_n,P,Q)
\land
\neg\operatorname{BoundedAbove}(x_n,\mathbb{R})
\Longrightarrow
\operatorname{DivergesToPositiveInfinity}(x_n,\mathbb{R}),\\
&\operatorname{OrderReversing}(x_n,P,Q)
\land
\neg\operatorname{BoundedBelow}(x_n,\mathbb{R})
\Longrightarrow
\operatorname{DivergesToNegativeInfinity}(x_n,\mathbb{R}).
\end{aligned}
\]
\end{remark*}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:algebraic-transformations-preserve-monotonicity}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Monotonicity}{NegationReversesDecreasing}{pending}
\LeanFormalizes{thm:algebraic-transformations-preserve-monotonicity}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Monotonicity}{NegationReversesIncreasing}{pending}
\LeanFormalizes{thm:algebraic-transformations-preserve-monotonicity}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Monotonicity}{NegativeScalarReversesIncreasing}{pending}
\LeanFormalizes{thm:algebraic-transformations-preserve-monotonicity}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Monotonicity}{PositiveScalarPreservesIncreasing}{pending}
\LeanFormalizes{thm:algebraic-transformations-preserve-monotonicity}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Monotonicity}{TranslationPreservesDecreasing}{pending}
\LeanFormalizes{thm:algebraic-transformations-preserve-monotonicity}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Monotonicity}{TranslationPreservesIncreasing}{pending}
...
\begin{aligned}
&x_n\colon\mathbb{N}\to\mathbb{R},\quad
x_n+c\colon\mathbb{N}\to\mathbb{R},\quad
\alpha x_n\colon\mathbb{N}\to\mathbb{R},\\
&P=\mathsf{OrderedSet}(\mathbb{N},\leq),\quad
Q=\mathsf{OrderedSet}(\mathbb{R},\leq),\\
&\operatorname{OrderPreserving}(x_n,P,Q)
\Longrightarrow
\operatorname{OrderPreserving}(x_n+c,P,Q),\\
&\operatorname{OrderPreserving}(x_n,P,Q)\land\alpha>0
\Longrightarrow
\operatorname{OrderPreserving}(\alpha x_n,P,Q),\\
&\operatorname{OrderPreserving}(x_n,P,Q)\land\alpha<0
\Longrightarrow
\operatorname{OrderReversing}(\alpha x_n,P,Q).
\end{aligned}
\]
\end{remark*}
...
% Lean-aligned addition: thm:increasing-bounded-below-by-first-term
\begin{theorem}[Increasing Sequences Are Bounded Below by the First Term]
\label{thm:increasing-bounded-below-by-first-term}
If $(x_n)$ is increasing, then $x_1\le x_n$ for every $n$; hence the sequence is bounded below by its first term.

\smallskip
\noindent
\hyperref[prf:increasing-bounded-below-by-first-term]{\textit{Go to proof.}}
\end{theorem}
\LeanFormalizes{thm:increasing-bounded-below-by-first-term}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Monotonicity}{IncreasingBoundedBelowByFirstTerm}{pending}
...
\NoLocalDependencies
\end{dependencies}
% Lean-aligned addition: thm:decreasing-bounded-above-by-first-term
\begin{theorem}[Decreasing Sequences Are Bounded Above by the First Term]
\label{thm:decreasing-bounded-above-by-first-term}
If $(x_n)$ is decreasing, then $x_n\le x_1$ for every $n$; hence the sequence is bounded above by its first term.

\smallskip
\noindent
\hyperref[prf:decreasing-bounded-above-by-first-term]{\textit{Go to proof.}}
\end{theorem}
\LeanFormalizes{thm:decreasing-bounded-above-by-first-term}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Monotonicity}{DecreasingBoundedAboveByFirstTerm}{pending}
