...
\]
\end{definition}
\LeanFormalizes{def:little-o-at-a-point}{lra-lean}{LRA.VolumeIII.Analysis.RealAnalysis.AsymptoticAndInequalityAdditions}{IsBigOAt}{pending}
\LeanFormalizes{def:little-o-at-a-point}{lra-lean}{LRA.VolumeIII.Analysis.RealAnalysis.AsymptoticNotation}{IsLittleOAt}{pending}
...
Let \(\ell p\) denote the limit-point datum determined by the basepoint \(a\)
and the domain \(D\). Then
\[
f=o(g)\ (x\to a)
\Longleftrightarrow
\operatorname{NegligibleAt}(f,g,\ell p).
\]
\end{remark*}
...
\]
\end{definition}
\LeanFormalizes{def:little-o-at-infinity}{lra-lean}{LRA.VolumeIII.Analysis.RealAnalysis.AsymptoticAndInequalityAdditions}{IsBigOAtTop}{pending}
\LeanFormalizes{def:little-o-at-infinity}{lra-lean}{LRA.VolumeIII.Analysis.RealAnalysis.AsymptoticNotation}{IsLittleOAtTop}{pending}
...
\begin{itemize}
  \item \hyperref[def:absolute-value]{Absolute Value}
  \item \hyperref[def:real-ordered-field]{Ordered Field Structure on \(\mathbb{R}\)}
\end{itemize}
\end{dependencies}
...
\]
\end{definition}
\LeanFormalizes{def:increment-little-o}{lra-lean}{LRA.VolumeIII.Analysis.RealAnalysis.AsymptoticNotation}{IsIncrementLittleO}{pending}
...
\begin{remark*}[Predicate reading]
\[
\bigl(f=o(g)\text{ at }a\bigr)\land
\bigl(m\text{ is bounded near }a\bigr)
\Longrightarrow
mf=o(g)\text{ at }a.
\]
\end{remark*}
...
% Lean-aligned addition: thm:little-o-implies-big-o-at-top
\begin{theorem}[Little-o Implies Big-O at Infinity]
\label{thm:little-o-implies-big-o-at-top}
If $f(x)=o(g(x))$ as $x\to+\infty$, then $f(x)=O(g(x))$ as $x\to+\infty$.

\smallskip
\noindent
\hyperref[prf:little-o-implies-big-o-at-top]{\textit{Go to proof.}}
\end{theorem}
