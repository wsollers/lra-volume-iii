...
\end{proposition}
\LeanFormalizes{prop:open-nested-intervals-need-not-have-nonempty-intersection}{lra-lean}{LRA.VolumeIII.Analysis.Completeness.NestedIntervalProperty}{OpenNestedIntervalsNeedNotHaveNonemptyIntersection}{pending}
