...
\end{proposition}
\LeanFormalizes{prop:negative-dilation-sends-lower-to-upper-bounds}{lra-lean}{LRA.VolumeIII.Analysis.Bounding.BoundAlgebra.BoundAlgebra}{NegativeDilationSendsLowerToUpperBounds}{pending}
