...
\input{volume-iii/book-analysis-ii/differentiation/notes/mean-value-theorem/figure-rolle}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:rolles-theorem}{lra-lean}{LRA.VolumeIII.Analysis.Differentiation.MeanValueTheorem}{RollesTheorem}{pending}

\begin{remark*}[Standard quantified statement]
\begin{align*}
&\operatorname{IsContinuous}(f,[a,b],\mathbb{R},\mathbb{R})
\;\land\;
\forall x \in (a,b)\;\operatorname{IsDifferentiable}(f,x,\mathbb{R},\mathbb{R})
\;\land\;
f(a)=f(b)\\
&\quad\Rightarrow\;
...
&\operatorname{IsContinuous}(f,[a,b],\mathbb{R},\mathbb{R})
\;\land\;
\operatorname{IsDifferentiable}(f,(a,b),\mathbb{R},\mathbb{R})
\;\land\;
f(a)=f(b)\\
&\quad\Longrightarrow\;
\exists c\in(a,b)\;:\;\operatorname{Derivative}(0,f,c,\mathbb{R},\mathbb{R}).
...
\begin{align*}
&\bigl(\forall c\in(a,b)\;:\;\neg\operatorname{Derivative}(0,f,c,\mathbb{R},\mathbb{R})\bigr)\\
&\quad\Longrightarrow\;
\neg\operatorname{IsContinuous}(f,[a,b],\mathbb{R},\mathbb{R})
\;\lor\;
\neg\operatorname{IsDifferentiable}(f,(a,b),\mathbb{R},\mathbb{R})
\;\lor\;
f(a)\ne f(b).
\end{align*}
...
\input{volume-iii/book-analysis-ii/differentiation/notes/mean-value-theorem/figure-mvt}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:mean-value-theorem}{lra-lean}{LRA.VolumeIII.Analysis.Differentiation.MeanValueTheorem}{MeanValueTheorem}{pending}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:cauchy-mean-value-theorem}{lra-lean}{LRA.VolumeIII.Analysis.Differentiation.MeanValueTheorem}{CauchyMeanValueTheorem}{pending}

\begin{remark*}[Standard quantified statement]
\begin{align*}
&\operatorname{IsContinuous}(f,[a,b],\mathbb{R},\mathbb{R})
\land \operatorname{IsContinuous}(g,[a,b],\mathbb{R},\mathbb{R})
\land \operatorname{IsDifferentiable}(f,(a,b),\mathbb{R},\mathbb{R})
\land \operatorname{IsDifferentiable}(g,(a,b),\mathbb{R},\mathbb{R})\\
&\quad\Longrightarrow\;
\exists c\in(a,b)\;
...
&\quad\Longrightarrow\
\neg\operatorname{IsContinuous}(f,[a,b],\mathbb{R},\mathbb{R})
\vee \neg\operatorname{IsContinuous}(g,[a,b],\mathbb{R},\mathbb{R})
\vee \neg\operatorname{IsDifferentiable}(f,(a,b),\mathbb{R},\mathbb{R})
\vee \neg\operatorname{IsDifferentiable}(g,(a,b),\mathbb{R},\mathbb{R}).
\end{aligned}
\]
...
\end{corollary}
\end{corollarybox}
\LeanFormalizes{cor:derivative-bound-implies-lipschitz}{lra-lean}{LRA.VolumeIII.Analysis.Differentiation.MeanValueTheorem}{DerivativeBoundImpliesLipschitz}{pending}
...
\begin{aligned}
  f\colon A\to\mathbb{R},\\
  \operatorname{IsBoundedDerivative}(f,I)
  \Longrightarrow
  \operatorname{IsLipschitz}(f,I,\mathbb{R},\mathbb{R},M).
\end{aligned}
\]
\end{remark*}
