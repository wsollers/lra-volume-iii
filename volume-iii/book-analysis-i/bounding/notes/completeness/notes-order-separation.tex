...
\[
\operatorname{LeftOf}(A,B)\Rightarrow \operatorname{SeparatedByPoint}(A,B).
\]
\end{remark*}
...
\[
\operatorname{LeftOf}(A,B)\land\neg\operatorname{SeparatedByPoint}(A,B).
\]
\end{remark*}
...
\begin{remark*}[Predicate reading]
\[
\operatorname{DedekindSeparation}(A,B)\Rightarrow
\operatorname{SeparatedByPoint}(A,B).
\]
\end{remark*}
\begin{remark*}[Negated quantified statement]
\[
\exists A,B\subseteq\mathbb{R}\;
\bigl(\operatorname{DedekindSeparation}(A,B)\land
\neg\operatorname{SeparatedByPoint}(A,B)\bigr).
\]
\end{remark*}
\begin{remark*}[Negation predicate reading]
\[
\operatorname{DedekindGap}(A,B).
\]
\end{remark*}
\begin{remark*}[Interpretation]
...
\begin{remark*}[Standard quantified statement]
\[
\neg\exists A,B\subseteq\mathbb{R}\;\operatorname{DedekindGap}(A,B).
\]
\end{remark*}
\begin{remark*}[Predicate reading]
\[
\operatorname{OrderComplete}(\mathbb{R}).
\]
\end{remark*}
\begin{remark*}[Negated quantified statement]
\[
\exists A,B\subseteq\mathbb{R}\;\operatorname{DedekindGap}(A,B).
\]
\end{remark*}
\begin{remark*}[Negation predicate reading]
\[
\neg\operatorname{OrderComplete}(\mathbb{R}).
\]
\end{remark*}
\begin{remark*}[Interpretation]
