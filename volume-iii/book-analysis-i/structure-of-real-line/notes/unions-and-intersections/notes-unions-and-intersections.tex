...
\begin{exposition}
The general set-operation notation was fixed in
\S\ref{sec:set-operations-on-real-line}. This section applies that notation
to the topology of \(\mathbb R\): the open closure laws of
\S\ref{sec:open-sets} dualize to closed sets by complementation. Collecting
them gives the open/closed bookkeeping rules used throughout the rest of the
development.
\end{exposition}
\end{topicbox}
