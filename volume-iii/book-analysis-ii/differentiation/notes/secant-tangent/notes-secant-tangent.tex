...
\begin{aligned}
  ...
  \operatorname{SecantLine}(\ell,f,a,b).
\end{aligned}
\]
\end{remark*}
...
\begin{itemize}
  ...
  \item \hyperref[def:euclid-line]{Euclidean Line}
...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:tangent-line}{lra-lean}{LRA.VolumeIII.Analysis.Differentiation.SecantTangent}{TangentLine}{pending}

\begin{remark*}[Standard quantified statement]
\[
\operatorname{IsDifferentiable}(f,c,\mathbb{R},\mathbb{R}) \;\Rightarrow\;
\operatorname{HasLinearApproximation}(f, c) = f(c) + f'(c)(x - c).
\]
\end{remark*}
