...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:strictly-increasing-index-map}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Subsequences}{IsStrictlyIncreasingIndexMap}{pending}
...
\[
\begin{gathered}
\sigma\colon\mathbb{N}\to\mathbb{N},\quad
P=\mathsf{OrderedSet}(\mathbb{N},\leq),\\
\operatorname{StrictOrderPreserving}(\sigma,P,P)
\coloneqq
\forall k,\ell\in\mathbb{N}\;(k<\ell\Longrightarrow \sigma(k)<\sigma(\ell)).
\end{gathered}
\]
...
\sigma\colon\mathbb{N}\to\mathbb{N},\quad
P=\mathsf{OrderedSet}(\mathbb{N},\leq),\\
\neg\operatorname{StrictOrderPreserving}(\sigma,P,P)
\Longleftrightarrow
\exists k,\ell\in\mathbb{N}\;(k<\ell\land \sigma(\ell)\le \sigma(k)).
\end{gathered}
\]
...
\label{def:subsequence-of-sequence}
...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:subsequence-of-sequence}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Subsequences}{IsSubsequenceOf}{pending}
...
\begin{remark*}[Predicate reading]
\[
\operatorname{IsSubsequence}(y_k,x_n)
\coloneqq
\exists \sigma\;
\bigl(
  \sigma\colon\mathbb{N}\to\mathbb{N}
  \land
  P=\mathsf{OrderedSet}(\mathbb{N},\leq)
  \land
  \operatorname{StrictOrderPreserving}(\sigma,P,P)
...
\begin{remark*}[Negation predicate reading]
\[
\neg\operatorname{IsSubsequence}(y_k,x_n).
\]
\end{remark*}
\begin{remark*}[Failure modes]
\begin{description}
  \item[Exposition.]
Failure is witnessed by the negated condition displayed above.
  \item[\(\operatorname{IsSubsequence}.\)]
\[
\begin{aligned}
&(y_k)\text{ is not a subsequence of }(x_n)\\
&\quad\Longleftrightarrow\quad
...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:subsequential-limit}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Subsequences}{IsSubsequentialLimit}{pending}
...
\begin{remark*}[Predicate reading]
\[
\operatorname{IsClusterValue}(x_n,L,\mathbb{R})
\coloneqq
\exists \sigma\;
\bigl(
  \sigma\colon\mathbb{N}\to\mathbb{N}
  ...
  \operatorname{StrictOrderPreserving}(\sigma,P,P)
  \land
  \operatorname{ConvergesTo}(x_{\sigma(k)},L,\mathbb{R})
\bigr).
\]
\end{remark*}
...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:has-convergent-subsequence}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Subsequences}{HasConvergentSubsequence}{pending}
...
\begin{remark*}[Predicate reading]
\[
\operatorname{HasConvergentSubsequence}(x_n,\mathbb{R})
\coloneqq
\exists L\in\mathbb{R}\;\operatorname{IsClusterValue}(x_n,L,\mathbb{R}).
\]
\end{remark*}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:subsequence-indices-dominate-identity}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Subsequences}{SubsequenceIndicesDominateIdentity}{pending}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:subsequences-preserve-limits}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Subsequences}{SubsequencesPreserveLimits}{pending}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:subsequential-limit-of-convergent-sequence}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Subsequences}{SubsequentialLimitOfConvergentSequence}{pending}
...
\operatorname{ConvergesTo}(x_n,L,\mathbb{R})
\land
\operatorname{IsClusterValue}(x_n,K,\mathbb{R})
\Longrightarrow
K=L.
\]
\end{remark*}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:divergence-by-two-subsequential-limits}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Subsequences}{DivergenceByTwoSubsequentialLimits}{pending}
...
L\neq K
\Longrightarrow
\neg\exists A\in\mathbb{R}\;\operatorname{ConvergesTo}(x_n,A,\mathbb{R}).
\]
\end{remark*}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:boundedness-passes-to-subsequences}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Subsequences}{BoundednessPassesToSubsequences}{pending}
...
\operatorname{StrictOrderPreserving}(\sigma,P,P)
\Longrightarrow
\operatorname{Bounded}(x_{\sigma(k)},\mathbb{R}).
\end{gathered}
\]
\end{remark*}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:monotonicity-passes-to-subsequences}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Subsequences}{MonotonicityPassesToSubsequencesDecr}{pending}
\LeanFormalizes{thm:monotonicity-passes-to-subsequences}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Subsequences}{MonotonicityPassesToSubsequencesIncr}{pending}
...
x_{\sigma(k)}\colon\mathbb{N}\to\mathbb{R},\\
...
\operatorname{StrictOrderPreserving}(\sigma,P,P)
\Longrightarrow
\operatorname{OrderPreserving}(x_{\sigma(k)},P,Q).
\end{gathered}
\]
\end{remark*}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:subsequence-of-subsequence}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Subsequences}{SubsequenceOfSubsequence}{pending}
...
\begin{gathered}
\sigma\colon\mathbb{N}\to\mathbb{N},\quad
\tau\colon\mathbb{N}\to\mathbb{N},\quad
P=\mathsf{OrderedSet}(\mathbb{N},\leq),\\
\operatorname{StrictOrderPreserving}(\sigma,P,P)
\land
\operatorname{StrictOrderPreserving}(\tau,P,P)
\Longrightarrow
\operatorname{IsSubsequence}(x_{\sigma(\tau(k))},x_n).
\end{gathered}
\]
\end{remark*}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:eventual-properties-pass-to-subsequences}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Subsequences}{EventualPropertiesPassToSubsequences}{pending}
...
\begin{gathered}
\sigma\colon\mathbb{N}\to\mathbb{N},\quad
P_0=\mathsf{OrderedSet}(\mathbb{N},\leq),\\
\operatorname{Eventually}(x_n,P)
\land
\operatorname{StrictOrderPreserving}(\sigma,P_0,P_0)
\Longrightarrow
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:frequent-properties-yield-subsequences}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Subsequences}{FrequentPropertiesYieldSubsequences}{pending}
...
\Longrightarrow
\exists \sigma\;\bigl(\sigma\colon\mathbb{N}\to\mathbb{N}
\land
\operatorname{StrictOrderPreserving}(\sigma,P_0,P_0)
\land
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:subsequential-limits-respect-bounds}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Subsequences}{SubsequentialLimitsRespectBounds}{pending}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:squeeze-passes-to-subsequences}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Subsequences}{SqueezePassesToSubsequences}{pending}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:monotone-subsequence-theorem}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Subsequences}{MonotoneSubsequenceTheorem}{pending}
...
\operatorname{OrderPreserving}((x_{\sigma(k)}),P,Q)
\lor
\operatorname{OrderReversing}((x_{\sigma(k)}),P,Q)
\bigr]
\bigr).
\end{aligned}
\]
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:bolzano-weierstrass-sequences}{lra-lean}{LRA.VolumeIII.Analysis.Completeness.CompletenessEquivalences}{StandardCompletenessEquivalences}{pending}
\LeanFormalizes{thm:bolzano-weierstrass-sequences}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Subsequences}{BolzanoWeierstrassSequences}{pending}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:sequential-compactness-closed-bounded-interval}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Subsequences}{SequentialCompactnessClosedBoundedInterval}{pending}
...
\Longrightarrow
\exists L\in[a,b]\;\operatorname{IsClusterValue}(x_n,L,\mathbb{R}).
\]
\end{remark*}
...
% Lean-aligned addition: thm:subsequence-principle
\begin{theorem}[Subsequence Principle]
\label{thm:subsequence-principle}
A sequence $(x_n)$ converges to $L$ if and only if every subsequence of $(x_n)$ has a further subsequence that converges to $L$.

\smallskip
\noindent
\hyperref[prf:subsequence-principle]{\textit{Go to proof.}}
\end{theorem}
\LeanFormalizes{thm:subsequence-principle}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Subsequences}{SubsequencePrinciple}{pending}
...
\NoLocalDependencies
\end{dependencies}
% Lean-aligned addition: thm:bounded-sequence-converges-iff-unique-subsequential-limit
\begin{theorem}[Bounded Sequence Convergence and Unique Subsequential Limit]
\label{thm:bounded-sequence-converges-iff-unique-subsequential-limit}
A bounded real sequence converges to $L$ if and only if $L$ is its unique subsequential limit.

\smallskip
\noindent
\hyperref[prf:bounded-sequence-converges-iff-unique-subsequential-limit]{\textit{Go to proof.}}
\end{theorem}
\LeanFormalizes{thm:bounded-sequence-converges-iff-unique-subsequential-limit}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Subsequences}{BoundedSequenceConvergesIffUniqueSubsequentialLimit}{pending}
