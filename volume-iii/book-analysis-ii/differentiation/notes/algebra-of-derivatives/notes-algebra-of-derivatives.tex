...
\[
\operatorname{IsDifferentiable}(f,c) \;\Rightarrow\;
\operatorname{Derivative}(\alpha f,\,c,\,\alpha f'(c)).
\]
\end{remark*}
...
\begin{remark*}[Standard quantified statement]
\[
\operatorname{IsDifferentiable}(f,c) \;\land\; \operatorname{IsDifferentiable}(g,c)
\;\Rightarrow\;
\operatorname{Derivative}(f+g,\,c,\,f'(c)+g'(c)).
\]
\end{remark*}
...
\operatorname{IsDifferentiable}(f,c) \;\land\; \operatorname{IsDifferentiable}(g,c)
\;\Rightarrow\;
\operatorname{Derivative}(fg,\,c,\,f'(c)g(c)+f(c)g'(c)).
\]
\end{remark*}
...
\begin{remark*}[Standard quantified statement]
\[
\operatorname{IsDifferentiable}(f,c) \;\land\; \operatorname{IsDifferentiable}(g,c) \;\land\; g(c)\neq 0
\;\Rightarrow\;
...
\begin{remark*}[Standard quantified statement]
\[
\forall i \in \{1,\dots,n\}\;\operatorname{IsDifferentiable}(f_i,c)
\;\Rightarrow\;
...
\begin{remark*}[Standard quantified statement]
\[
\forall i\;\operatorname{IsDifferentiable}(f_i,c)
\;\Rightarrow\;
...
\begin{remark*}[Standard quantified statement]
\[
\operatorname{IsDifferentiable}(f,c) \;\land\; n \in \mathbb{N}
\;\Rightarrow\;
\operatorname{Derivative}(f^n,\,c,\,n(f(c))^{n-1}f'(c)).
\]
\end{remark*}
...
\begin{remark*}[Standard quantified statement]
\[
\forall x \in I\;\operatorname{IsDifferentiable}(f,x)
\;\Rightarrow\;
\forall x \in I\;\operatorname{Derivative}(\alpha f,\,x,\,\alpha f'(x)).
\]
\end{remark*}
...
\begin{remark*}[Standard quantified statement]
\[
\forall x \in I\;\bigl(\operatorname{IsDifferentiable}(f,x) \land \operatorname{IsDifferentiable}(g,x)\bigr)
\;\Rightarrow\;
\forall x \in I\;\operatorname{Derivative}(f+g,\,x,\,f'(x)+g'(x)).
\]
\end{remark*}
...
\forall x \in I\;\bigl(\operatorname{IsDifferentiable}(f,x)\land\operatorname{IsDifferentiable}(g,x)\bigr)
\;\Rightarrow\;
\forall x \in I\;\operatorname{Derivative}(fg,\,x,\,f'(x)g(x)+f(x)g'(x)).
\]
\end{remark*}
...
\begin{remark*}[Standard quantified statement]
\[
\forall x \in I\;\bigl(\operatorname{IsDifferentiable}(f,x)\land\operatorname{IsDifferentiable}(g,x)\land g(x)\neq 0\bigr)
\;\Rightarrow\;
...
\begin{remark*}[Standard quantified statement]
\[
\forall i\;\forall x\in I\;\operatorname{IsDifferentiable}(f_i,x)
\;\Rightarrow\;
...
\begin{remark*}[Standard quantified statement]
\[
\forall x\in I\;\operatorname{IsDifferentiable}(f,x) \;\land\; n\in\mathbb{N}
\;\Rightarrow\;
\forall x\in I\;\operatorname{Derivative}(f^n,\,x,\,n(f(x))^{n-1}f'(x)).
\]
\end{remark*}
