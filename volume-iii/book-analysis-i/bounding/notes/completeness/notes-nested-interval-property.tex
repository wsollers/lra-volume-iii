...
\[
\operatorname{NestedStep}([a_{n+1},b_{n+1}],[a_n,b_n])
\Longrightarrow
\operatorname{OrderedEndpoints}(a_n,a_{n+1},b_{n+1},b_n).
\]
\end{remark*}
...
\Longrightarrow
\operatorname{MonotoneIncreasing}(a_n).
\]
\end{remark*}
...
\begin{remark*}[Negation predicate reading]
\[
\neg\operatorname{MonotoneIncreasing}(a_n)
\Longrightarrow
\neg\operatorname{NestedClosedIntervals}([a_n,b_n]).
\]
\end{remark*}
...
\operatorname{NestedClosedIntervals}([a_n,b_n])
\Longrightarrow
\operatorname{MonotoneDecreasing}(b_n).
\]
\end{remark*}
...
\begin{remark*}[Negation predicate reading]
\[
\neg\operatorname{MonotoneDecreasing}(b_n)
\Longrightarrow
\neg\operatorname{NestedClosedIntervals}([a_n,b_n]).
\]
\end{remark*}
...
\operatorname{NestedClosedIntervals}([a_n,b_n])
\Longrightarrow
\forall m,n\in\mathbb{N}\;\operatorname{Below}(a_n,b_m).
\]
\end{remark*}
...
\operatorname{NestedClosedIntervals}([a_n,b_n])
\land
\operatorname{Supremum}(\alpha,\{a_n:n\in\mathbb{N}\})
\land
\operatorname{Infimum}(\beta,\{b_n:n\in\mathbb{N}\})
\Longrightarrow
\alpha\le \beta.
\]
\end{remark*}
...
\neg\operatorname{NestedClosedIntervals}([a_n,b_n])
\lor
\neg\operatorname{Supremum}(\alpha,\{a_n:n\in\mathbb{N}\})
\lor
\neg\operatorname{Infimum}(\beta,\{b_n:n\in\mathbb{N}\}).
\]
\end{remark*}
...
\begin{remark*}[Predicate reading]
\[
\operatorname{NestedClosedBoundedIntervals}(I_n)\Longrightarrow
...
\Longrightarrow
\neg\operatorname{NestedClosedBoundedIntervals}([a_n,b_n]).
\]
\end{remark*}
...
\operatorname{Supremum}(\alpha,\{a_n:n\in\mathbb{N}\})
\Longrightarrow
\operatorname{IntersectionPoint}(\alpha,[a_n,b_n]).
\]
\end{remark*}
...
\operatorname{Infimum}(\beta,\{b_n:n\in\mathbb{N}\})
\Longrightarrow
\operatorname{IntersectionPoint}(\beta,[a_n,b_n]).
\]
\end{remark*}
...
\left(y\in\bigcap_{n=1}^{\infty}[a_n,b_n]\leftrightarrow y=x\right).
\]
\end{remark*}
...
\operatorname{NestedClosedBoundedIntervals}([a_n,b_n])
\land
\operatorname{VanishingLength}(b_n-a_n)
\Longrightarrow
\operatorname{SingletonIntersection}([a_n,b_n]).
\]
\end{remark*}
...
\begin{remark*}[Negation predicate reading]
\[
\neg\operatorname{SingletonIntersection}([a_n,b_n])
\Longrightarrow
\neg\operatorname{NestedClosedBoundedIntervals}([a_n,b_n])
\lor
\neg\operatorname{VanishingLength}(b_n-a_n).
\]
\end{remark*}
...
\left(\lim_{n\to\infty}a_n=L\land \lim_{n\to\infty}b_n=L\right).
\]
\end{remark*}
...
\operatorname{VanishingLength}(b_n-a_n)
\Longrightarrow
\operatorname{CommonEndpointLimit}(a_n,b_n).
\]
\end{remark*}
...
\left(\lim_{n\to\infty}a_n\ne L\lor \lim_{n\to\infty}b_n\ne L\right).
\]
\end{remark*}

\begin{remark*}[Negation predicate reading]
\[
\neg\operatorname{CommonEndpointLimit}(a_n,b_n)
\Longrightarrow
\neg\operatorname{NestedClosedBoundedIntervals}([a_n,b_n])
\lor
\neg\operatorname{VanishingLength}(b_n-a_n).
...
\right]
\Longrightarrow
\left(\lim_{n\to\infty}a_n=x\land \lim_{n\to\infty}b_n=x\right).
\]
\end{remark*}

\begin{remark*}[Predicate reading]
\[
\operatorname{SingletonIntersectionAt}(x,[a_n,b_n])
\land
\operatorname{VanishingLength}(b_n-a_n)
\Longrightarrow
\operatorname{EndpointLimit}(a_n,b_n,x).
\]
\end{remark*}
...
\left(\lim_{n\to\infty}a_n\ne x\lor \lim_{n\to\infty}b_n\ne x\right)
\Longrightarrow
\neg\operatorname{SingletonIntersectionAt}(x,[a_n,b_n])
\lor
\neg\operatorname{VanishingLength}(b_n-a_n).
\]
\end{remark*}
...
\[
\exists I_n\;\bigl(
\operatorname{NestedOpenBoundedIntervals}(I_n)
\land
\operatorname{EmptyIntersection}(I_n)
\bigr).
\]
\end{remark*}
...
\forall (a_n),(b_n)\;
\left[
\operatorname{NestedOpenBoundedIntervals}((a_n,b_n))
\Longrightarrow
\exists x\in\mathbb{R}\;\forall n\in\mathbb{N}\;(x\in(a_n,b_n))
\right].
\]
...
\exists I_n\;
\bigl(
\operatorname{NestedNonemptyBoundedIntervals}(I_n)
\land
\neg\operatorname{ClosedIntervals}(I_n)
\land
...
\operatorname{NestedIntervalConclusion}(I_n)
\text{ fail.}
\]
\end{remark*}
...
\bigcap_{n=1}^{\infty}I_n=\varnothing
\Longrightarrow
\neg\operatorname{NestedClosedBoundedIntervals}(I_n).
\]
\end{remark*}
...
\exists I_n\;
\bigl(
\operatorname{NestedNonemptyClosedIntervals}(I_n)
\land
\neg\operatorname{BoundedIntervals}(I_n)
\land
\bigcap_{n=1}^{\infty}I_n=\varnothing
\bigr).
\]
