...
\[
\neg\operatorname{OrderPreserving}(x_n)
\Longleftrightarrow
\exists n\in\mathbb{N}\;(x_{n+1}<x_n).
\]
\end{remark*}
...
\begin{remark*}[Negation predicate reading]
\[
\neg\operatorname{OrderReversing}(x_n)
\Longleftrightarrow
\exists n\in\mathbb{N}\;(x_n<x_{n+1}).
\]
\end{remark*}
...
\begin{remark*}[Predicate reading]
\[
\operatorname{StrictOrderPreserving}(x_n)
\coloneqq
\forall n\in\mathbb{N}\;(x_n<x_{n+1}).
\]
\end{remark*}
...
\begin{remark*}[Negation predicate reading]
\[
\neg\operatorname{StrictOrderPreserving}(x_n)
\Longleftrightarrow
\exists n\in\mathbb{N}\;(x_{n+1}\le x_n).
\]
\end{remark*}
...
\begin{remark*}[Predicate reading]
\[
\operatorname{StrictOrderReversing}(x_n)
\coloneqq
\forall n\in\mathbb{N}\;(x_{n+1}<x_n).
\]
\end{remark*}
...
\begin{remark*}[Negation predicate reading]
\[
\neg\operatorname{StrictOrderReversing}(x_n)
\Longleftrightarrow
\exists n\in\mathbb{N}\;(x_n\le x_{n+1}).
\]
\end{remark*}
...
\operatorname{BoundedAbove}(x_n)
\land
\neg\exists L\in\mathbb{R}\;\operatorname{ConvergesTo}(x_n,L),\\
&\operatorname{OrderReversing}(x_n)
\land
\operatorname{BoundedBelow}(x_n)
\land
...
\Longrightarrow
\Bigl(
\exists L\in\mathbb{R}\;\operatorname{ConvergesTo}(x_n,L)
\Longleftrightarrow
\operatorname{BoundedAbove}(x_n)
\Bigr),\\
&\operatorname{OrderReversing}(x_n)
...
&\operatorname{OrderPreserving}(x_n)
\land
\neg\operatorname{BoundedAbove}(x_n)
\Longrightarrow
\operatorname{DivergesToPositiveInfinity}(x_n),\\
&\operatorname{OrderReversing}(x_n)
\land
\neg\operatorname{BoundedBelow}(x_n)
\Longrightarrow
...
&\operatorname{OrderPreserving}(x_n)
\Longrightarrow
\operatorname{OrderPreserving}(x_n+c),\\
&\operatorname{OrderPreserving}(x_n)\land\alpha>0
\Longrightarrow
\operatorname{OrderPreserving}(\alpha x_n),\\
&\operatorname{OrderPreserving}(x_n)\land\alpha<0
\Longrightarrow
\operatorname{OrderReversing}(\alpha x_n).
\end{aligned}
\]
\end{remark*}
