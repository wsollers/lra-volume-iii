...
\[
\operatorname{Oscillation}(f,E,\omega)
\coloneqq
\omega=\sup\{\,|f(x_1)-f(x_2)|:x_1,x_2\in E\,\}.
\]
\end{remark*}
...
\[
\neg\operatorname{Oscillation}(f,E,\omega)
\Longleftrightarrow
\omega\ne\sup\{\,|f(x_1)-f(x_2)|:x_1,x_2\in E\,\}.
\]
\end{remark*}
...
\begin{remark*}[Predicate reading]
\[
\operatorname{Oscillation}(f,x_0,\omega) \coloneqq
...
\begin{remark*}[Negation predicate reading]
\[
\neg\operatorname{Oscillation}(f,x_0,\omega)
\Longleftrightarrow
\Bigl[\exists \delta_0>0:\, U_{\delta_0}(x_0)\cap E = \varnothing\Bigr]
\lor
\Bigl(\exists \varepsilon_0>0\; \forall \delta>0\; \exists r\;(0<r<\delta \land |\omega(f;U_r(x_0)\cap E)-\omega| \ge \varepsilon_0)\Bigr).
...
\begin{remark*}[Predicate reading]
\[
\operatorname{IsContinuous}(f,c) \Longleftrightarrow \operatorname{Oscillation}(f,c,0).
\]
\end{remark*}
...
\begin{remark*}[Negation predicate reading]
\[
\neg\bigl(\operatorname{IsContinuous}(f,c) \Longleftrightarrow \operatorname{Oscillation}(f,c,0)\bigr).
\]
\end{remark*}
...
\begin{description}
  \item[Exposition.]
\[
\underbrace{\operatorname{IsContinuous}(f,c) \land \neg \operatorname{Oscillation}(f,c,0)}_{\text{Positive oscillation despite continuity}}
\;\lor\;
\underbrace{\neg \operatorname{IsContinuous}(f,c) \land \operatorname{Oscillation}(f,c,0)}_{\text{Zero oscillation without continuity}}.
\]
\end{description}
\end{remark*}
...
&x\in D(f)
\Longleftrightarrow
\operatorname{IsDiscontinuous}(f,x)\\
&\Longleftrightarrow
\exists \omega\;(\operatorname{Oscillation}(f,x,\omega)\land \omega>0)\\
&\Longleftrightarrow
\exists n\in\mathbb{N}\;\exists \omega\;(\operatorname{Oscillation}(f,x,\omega)\land \omega\ge \tfrac1n).
\end{aligned}
\]
\end{remark*}
...
\begin{aligned}
\exists x\in E\;\Bigl(
&\exists \omega\;(\operatorname{IsDiscontinuous}(f,x)\land \operatorname{Oscillation}(f,x,\omega)\land \omega=0)\;\lor\\
&\exists \omega\;(\neg\operatorname{IsDiscontinuous}(f,x)\land \operatorname{Oscillation}(f,x,\omega)\land \omega>0)\;\lor\\
&\exists \omega\;(\operatorname{Oscillation}(f,x,\omega)\land \omega>0\land \forall n\in\mathbb{N}\; \omega<\tfrac1n)
\Bigr).
\end{aligned}
\]
\end{remark*}
