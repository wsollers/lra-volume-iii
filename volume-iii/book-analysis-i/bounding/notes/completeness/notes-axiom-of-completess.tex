...
\begin{description}
  \item[Exposition.]
The property fails when there is a nonempty subset of the ambient partially
ordered set that has at least one upper bound but has no least upper bound
inside that same ambient set.
