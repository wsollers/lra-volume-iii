...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:right-hand-limit}{lra-lean}{LRA.VolumeIII.Analysis.Continuity.Limits}{TendsToRight}{pending}
...
\begin{aligned}
  ...
  \operatorname{RightLimit}(L,f,c,\mathbb{R},\mathbb{R})
  \;\coloneqq\;
  \forall\varepsilon>0\;\exists\delta>0\;\forall x\in A\;
  0<x-c<\delta\Rightarrow |f(x)-L|<\varepsilon.
\end{aligned}
...
\begin{aligned}
  f\colon A\to\mathbb{R},\\
  \neg\,\operatorname{RightLimit}(L,f,c,\mathbb{R},\mathbb{R}).
\end{aligned}
\]
\end{remark*}
...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:left-hand-limit}{lra-lean}{LRA.VolumeIII.Analysis.Continuity.Limits}{TendsToLeft}{pending}
...
\begin{aligned}
  f\colon A\to\mathbb{R},\\
  \operatorname{LeftLimit}(L,f,c,\mathbb{R},\mathbb{R})
  \;\coloneqq\;
  \forall\varepsilon>0\;\exists\delta>0\;\forall x\in A\;
  0<c-x<\delta\Rightarrow |f(x)-L|<\varepsilon.
\end{aligned}
...
\begin{aligned}
  f\colon A\to\mathbb{R},\\
  \neg\,\operatorname{LeftLimit}(L,f,c,\mathbb{R},\mathbb{R}).
\end{aligned}
\]
\end{remark*}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:two-sided-limit-iff-matching-one-sided-limits}{lra-lean}{LRA.VolumeIII.Analysis.Continuity.Limits}{TendstoIffOneSidedAgree}{pending}
...
\begin{aligned}
  ...
  \;\Longleftrightarrow\;
  \operatorname{RightLimit}(L,f,c,\mathbb{R},\mathbb{R})\wedge\operatorname{LeftLimit}(L,f,c,\mathbb{R},\mathbb{R}).
\end{aligned}
\]
\end{remark*}
...
\begin{aligned}
  ...
  \;\Longleftrightarrow\;
  \neg\,\operatorname{RightLimit}(L,f,c,\mathbb{R},\mathbb{R})\vee\neg\,\operatorname{LeftLimit}(L,f,c,\mathbb{R},\mathbb{R}).
\end{aligned}
\]
\end{remark*}
