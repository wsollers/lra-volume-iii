...
\section*{\texorpdfstring{Worked Example: Expanding \(f(n) = n^3\)}{Worked Example: Expanding f(n) = n cubed}}
...
\section*{\texorpdfstring{Application: Computing \(\sum_{k=0}^{n-1} k^2\)}{Application: Computing sum k=0 to n-1 k squared}}
