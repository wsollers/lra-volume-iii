...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:limit-point}{lra-lean}{LRA.VolumeIII.Analysis.StructureOfRealLine.OpenClosedSets}{IsLimitPoint}{pending}
...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:isolated-point}{lra-lean}{LRA.VolumeIII.Analysis.StructureOfRealLine.OpenClosedSets}{IsIsolatedPoint}{pending}
\begin{remark*}[Standard quantified statement]
\[
