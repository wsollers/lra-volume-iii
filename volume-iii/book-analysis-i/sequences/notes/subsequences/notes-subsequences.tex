...
\[
\operatorname{StrictOrderPreserving}(\sigma)
\coloneqq
\forall k,\ell\in\mathbb{N}\;(k<\ell\Longrightarrow \sigma(k)<\sigma(\ell)).
\]
\end{remark*}
...
\[
\neg\operatorname{StrictOrderPreserving}(\sigma)
\Longleftrightarrow
\exists k,\ell\in\mathbb{N}\;(k<\ell\land \sigma(\ell)\le \sigma(k)).
\]
\end{remark*}
...
\begin{remark*}[Predicate reading]
\[
\operatorname{IsClusterValue}(x_n,L)
\coloneqq
\exists \sigma\;
\bigl(
  \operatorname{StrictOrderPreserving}(\sigma)
  \land
  \operatorname{ConvergesTo}(x_{\sigma(k)},L)
\bigr).
\]
\end{remark*}
...
\coloneqq
\exists L\in\mathbb{R}\;\operatorname{IsClusterValue}(x_n,L).
\]
\end{remark*}
...
\operatorname{ConvergesTo}(x_n,L)
\land
\operatorname{IsClusterValue}(x_n,K)
\Longrightarrow
K=L.
\]
\end{remark*}
...
L\neq K
\Longrightarrow
\neg\exists A\in\mathbb{R}\;\operatorname{ConvergesTo}(x_n,A).
\]
\end{remark*}
...
\operatorname{StrictOrderPreserving}(\sigma)
\Longrightarrow
\operatorname{Bounded}(x_{\sigma(k)}).
\]
\end{remark*}
...
\operatorname{StrictOrderPreserving}(\sigma)
\Longrightarrow
\operatorname{OrderPreserving}(x_{\sigma(k)}).
\]
\end{remark*}
...
\operatorname{StrictOrderPreserving}(\sigma)
\land
\operatorname{StrictOrderPreserving}(\tau)
\Longrightarrow
...
\Longrightarrow
\exists \sigma\;\bigl(\operatorname{StrictOrderPreserving}(\sigma)
\land
...
\Longrightarrow
\exists L\in[a,b]\;\operatorname{IsClusterValue}(x_n,L).
\]
\end{remark*}
