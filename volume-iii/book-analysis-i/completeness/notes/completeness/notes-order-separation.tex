...
\end{dependencies}
\input{volume-iii/book-analysis-i/completeness/notes/completeness/figure-order-separation}
...
% Lean-aligned addition: def:rational-cut-upper-at-sqrt-two
\begin{definition}[Rational Cut Upper Part at Square Root Two]
\label{def:rational-cut-upper-at-sqrt-two}
The upper part of the rational cut at $\sqrt2$ is
\[
  U_{\mathbb Q,\sqrt2}:=\{q\in\mathbb Q:0\le q\text{ and }2\le q^2\}.
\]
\end{definition}
\LeanFormalizes{def:rational-cut-upper-at-sqrt-two}{lra-lean}{LRA.VolumeIII.Analysis.Completeness.CompletenessAdditions}{RationalCutUpperAtSqrtTwo}{pending}
...
\NoLocalDependencies
\end{dependencies}
% Lean-aligned addition: def:real-cut-lower-at-sqrt-two
\begin{definition}[Real Cut Lower Part at Square Root Two]
\label{def:real-cut-lower-at-sqrt-two}
The lower part of the real cut at $\sqrt2$ is
\[
  L_{\mathbb R,\sqrt2}:=\{x\in\mathbb R:x<\sqrt2\}.
\]
\end{definition}
\LeanFormalizes{def:real-cut-lower-at-sqrt-two}{lra-lean}{LRA.VolumeIII.Analysis.Completeness.CompletenessAdditions}{RealCutLowerAtSqrtTwo}{pending}
...
\NoLocalDependencies
\end{dependencies}
% Lean-aligned addition: def:real-cut-upper-at-sqrt-two
\begin{definition}[Real Cut Upper Part at Square Root Two]
\label{def:real-cut-upper-at-sqrt-two}
The upper part of the real cut at $\sqrt2$ is
\[
  U_{\mathbb R,\sqrt2}:=\{x\in\mathbb R:\sqrt2\le x\}.
\]
\end{definition}
\LeanFormalizes{def:real-cut-upper-at-sqrt-two}{lra-lean}{LRA.VolumeIII.Analysis.Completeness.CompletenessAdditions}{RealCutUpperAtSqrtTwo}{pending}
