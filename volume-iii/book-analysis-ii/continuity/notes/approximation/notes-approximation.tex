...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:step-function-approximation}{lra-lean}{LRA.VolumeIII.Analysis.Continuity.Approximation}{StepFunctionApproximation}{pending}
...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:piecewise-linear-function}{lra-lean}{LRA.VolumeIII.Analysis.Continuity.Approximation}{IsPiecewiseLinear}{pending}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:piecewise-linear-approximation}{lra-lean}{LRA.VolumeIII.Analysis.Continuity.Approximation}{PiecewiseLinearApproximation}{pending}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:weierstrass-approximation}{lra-lean}{LRA.VolumeIII.Analysis.Continuity.Approximation}{WeierstrassApproximation}{pending}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:bernstein-approximation}{lra-lean}{LRA.VolumeIII.Analysis.Continuity.Approximation}{BernsteinApproximation}{pending}
...
% Lean-aligned addition: def:is-step-function
\begin{definition}[Step Function on an Interval]
\label{def:is-step-function}
A function $g:[a,b]\to\mathbb R$ is a \emph{step function} if there is a finite partition $a=x_0<x_1<\cdots<x_n=b$ and constants $c_1,\ldots,c_n$ such that $g(x)=c_i$ for every $x\in(x_{i-1},x_i)$.
\end{definition}
\LeanFormalizes{def:is-step-function}{lra-lean}{LRA.VolumeIII.Analysis.Continuity.Approximation}{IsStepFunction}{pending}
