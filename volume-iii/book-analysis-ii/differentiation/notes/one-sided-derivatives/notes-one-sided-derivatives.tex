...
\[
\operatorname{LeftDerivative}(f, c, L)
\;\Longleftrightarrow\;
...
\[
\forall L \in \mathbb{R}\;\lnot\operatorname{LeftDerivative}(f, c, L).
\]
...
\begin{remark*}[Predicate reading]
\[
\operatorname{RightDerivative}(f, c, L)
\;\Longleftrightarrow\;
...
\begin{remark*}[Negation predicate reading]
\[
\forall L \in \mathbb{R}\;\lnot\operatorname{RightDerivative}(f, c, L).
\]
\end{remark*}
...
\;\iff\;
\Bigl(\operatorname{LeftDerivative}(f,c,L) \;\land\; \operatorname{RightDerivative}(f,c,L)\Bigr)
...
\begin{remark*}[Negated quantified statement]
\[
\lnot\operatorname{IsDifferentiable}(f,c)
\;\iff\;
\lnot\Bigl(\operatorname{LeftDerivative}(f,c,L) \;\land\; \operatorname{RightDerivative}(f,c,L)\Bigr)
