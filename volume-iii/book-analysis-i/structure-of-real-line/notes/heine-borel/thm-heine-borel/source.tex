...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:heine-borel}{lra-lean}{LRA.VolumeIII.Analysis.StructureOfRealLine.Compactness}{HeineBorel}{pending}
\LeanFormalizes{thm:heine-borel}{lra-lean}{LRA.VolumeIII.Analysis.StructureOfRealLine.CompactnessAdditions}{ClosedSubsetOfCompactIsCompact}{pending}
