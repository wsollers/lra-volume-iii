...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:sequence}{lra-lean}{LRA.VolumeII.RealNumbers.ConstructionModels}{Sequence}{pending}

\begin{remark*}[Standard quantified statement]
\[
\forall X \neq \varnothing \;\forall x : \mathbb{N} \to X
\;\bigl(\mathsf{Sequence}(x,X) \Longleftrightarrow x:\mathbb{N}\to X\bigr).
\]
\end{remark*}

\begin{remark*}[Predicate reading]
\[
\mathsf{Sequence}(x_n, X)
\;:=\;
x : \mathbb{N} \to X.
\]
\end{remark*}
