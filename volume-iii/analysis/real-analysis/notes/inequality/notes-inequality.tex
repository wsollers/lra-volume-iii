...
\begin{dependencies}
\hyperref[def:real-ordered-field]{Ordered field},
\hyperref[thm:ordered-field-positive-multiplication-preserves-order]{multiply positive},
...
\begin{dependencies}
\hyperref[def:real-ordered-field]{Ordered field},
\hyperref[thm:ordered-field-negative-multiplication-reverses-order]{multiply negative},
\hyperref[def:positive-cone]{positive cone}.
\end{dependencies}
...
\begin{dependencies}
\hyperref[def:real-ordered-field]{Ordered field},
\hyperref[thm:ordered-field-positive-inverses]{inverse positive},
...
\hyperref[thm:ineq-multiply-positive]{multiplication by positive preserves strict inequality},
\hyperref[thm:ordered-field-squares-nonnegative]{squares are nonnegative}.
\end{dependencies}
...
\hyperref[thm:ordered-field-squares-nonnegative]{squares being nonnegative}.
\end{remark*}
