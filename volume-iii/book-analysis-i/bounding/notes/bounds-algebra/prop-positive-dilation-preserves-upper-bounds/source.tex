...
\end{proposition}
\LeanFormalizes{prop:positive-dilation-preserves-upper-bounds}{lra-lean}{LRA.VolumeIII.Analysis.Bounding.BoundAlgebra.BoundAlgebra}{PositiveDilationPreservesUpperBounds}{pending}
