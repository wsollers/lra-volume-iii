...
\end{theorem}
\LeanFormalizes{thm:supremum-is-monotone-under-inclusion}{lra-lean}{LRA.VolumeIII.Analysis.Bounding.ExtremalBounds.SupremaInfima}{SupremumMonotoneUnderInclusion}{pending}
