...
\newpage
\phantomsection
\label{prf:absolute-bound-upper-lower-bounds}
\LRAProofFor{thm:absolute-bound-upper-lower-bounds}

\begin{remark*}[Return]
\hyperref[thm:absolute-bound-upper-lower-bounds]{Return to Theorem}
\end{remark*}
