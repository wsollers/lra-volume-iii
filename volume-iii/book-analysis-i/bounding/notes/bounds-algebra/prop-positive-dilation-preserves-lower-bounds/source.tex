...
\end{proposition}
\LeanFormalizes{prop:positive-dilation-preserves-lower-bounds}{lra-lean}{LRA.VolumeIII.Analysis.Bounding.BoundAlgebra.BoundAlgebra}{PositiveDilationPreservesLowerBounds}{pending}
