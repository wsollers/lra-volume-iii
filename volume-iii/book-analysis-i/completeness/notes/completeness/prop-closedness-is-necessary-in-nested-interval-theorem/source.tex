...
\end{proposition}
\LeanFormalizes{prop:closedness-is-necessary-in-nested-interval-theorem}{lra-lean}{LRA.VolumeIII.Analysis.Completeness.NestedIntervalProperty}{ClosednessIsNecessaryInNestedIntervalTheorem}{pending}
