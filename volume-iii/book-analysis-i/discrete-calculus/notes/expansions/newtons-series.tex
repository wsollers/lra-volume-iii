...
\textbf{Theorem (Newton Forward Difference Expansion).}
...
\begin{exposition}
The expansion is constructed term by term, matching the values of \(f\) at
successive integers.
...
\begin{center}
\input{volume-iii/book-analysis-i/discrete-calculus/notes/expansions/figure-newton-diagonal}
\end{center}
...
\begin{example*}
The difference table at \(n = 0\) is:
\[
