...
\[
\operatorname{IsLocalMinimum}(f, c)
\;\Longleftrightarrow\;
\exists \delta > 0\;\forall x \in A\;
...
\begin{remark*}[Predicate reading]
\[
\operatorname{IsLocalMaximum}(f, c)
\;\Longleftrightarrow\;
\exists \delta > 0\;\forall x \in A\;
...
\begin{remark*}[Standard quantified statement]
\[
\operatorname{IsLocalExtremum}(f, c)
\;\Longleftrightarrow\;
\operatorname{IsLocalMinimum}(f, c) \;\lor\; \operatorname{IsLocalMaximum}(f, c).
\]
\end{remark*}
...
\begin{remark*}[Standard quantified statement]
\[
\operatorname{IsLocalExtremum}(f, c) \;\land\; \operatorname{IsDifferentiable}(f, c)
\;\Rightarrow\; \operatorname{Derivative}(f, c, 0).
\]
\end{remark*}

\begin{remark*}[Interpretation]
\[
\operatorname{Derivative}(f, c, L) \;\land\; L \neq 0
\;\Rightarrow\; \lnot\operatorname{IsLocalExtremum}(f, c).
\]
...
\operatorname{Derivative}(f, c, L) \;\land\; L \neq 0
\;\Rightarrow\;
\lnot\operatorname{IsLocalMinimum}(f, c) \;\land\; \lnot\operatorname{IsLocalMaximum}(f, c).
\]
...
\operatorname{IsLocalExtremum}(f,c)
\;\Rightarrow\;
\lnot\operatorname{IsDifferentiable}(f,c) \;\lor\; \operatorname{Derivative}(f,c,0).
\]
\end{remark*}
...
\operatorname{IsLocalExtremum}(f,c)
\;\Rightarrow\;
\operatorname{Derivative}(f,c,0) \;\lor\; \lnot\operatorname{IsDifferentiable}(f,c).
\]
\end{remark*}
