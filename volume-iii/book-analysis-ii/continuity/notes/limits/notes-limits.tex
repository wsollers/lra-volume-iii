...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:limit-function}{lra-lean}{LRA.VolumeIII.Analysis.Continuity.Limits}{TendsTo}{pending}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:limit-unique}{lra-lean}{LRA.VolumeIII.Analysis.Continuity.Limits}{TendstoUnique}{pending}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:squeeze-function-limits}{lra-lean}{LRA.VolumeIII.Analysis.Continuity.Limits}{SqueezeFunctionLimits}{pending}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:composition-of-limits}{lra-lean}{LRA.VolumeIII.Analysis.Continuity.Limits}{TendstoComp}{pending}
...
% Lean-aligned addition: thm:sequential-criterion-tendsto
\begin{theorem}[Sequential Criterion for Function Limits]
\label{thm:sequential-criterion-tendsto}
Let $A\subseteq\mathbb R$, let $c$ be an adherent point of $A$, and let $f:A\to\mathbb R$. Then $\lim_{x\to c}f(x)=L$ if and only if for every sequence $(x_n)$ in $A\setminus\{c\}$ with $x_n\to c$, the sequence $f(x_n)$ converges to $L$.

\smallskip
\noindent
\hyperref[prf:sequential-criterion-tendsto]{\textit{Go to proof.}}
\end{theorem}
\LeanFormalizes{thm:sequential-criterion-tendsto}{lra-lean}{LRA.VolumeIII.Analysis.Continuity.Limits}{SequentialCriterionTendsto}{pending}
