...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:class-c1}{lra-lean}{LRA.VolumeIII.Analysis.Differentiation.GraphReading}{IsClassC1}{pending}

\begin{remark*}[Standard quantified statement]
\[
  f\in C^1(I)
  \Longleftrightarrow
  \bigl(\forall x\in I:\operatorname{IsDifferentiable}(f,x,\mathbb{R},\mathbb{R})\bigr)
  \land
...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:class-ck}{lra-lean}{LRA.VolumeIII.Analysis.Differentiation.GraphReading}{IsClassCk}{pending}
...
\[
  ...
  \neg\operatorname{IsContinuous}(f^{(k)},x,\mathbb{R},\mathbb{R})\bigr].
\]
\end{remark*}
...
\(\neg\operatorname{IsClassC}(f,k,I)\): somewhere the \(k\)-th derivative
...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:class-cinfty}{lra-lean}{LRA.VolumeIII.Analysis.Differentiation.GraphReading}{IsClassCInfty}{pending}
...
\begin{description}
  \item[Exposition.]
  Smoothness fails as soon as one finite differentiability level fails.
...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:class-comega}{lra-lean}{LRA.VolumeIII.Analysis.Differentiation.GraphReading}{IsClassCOmega}{pending}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:smoothness-tower}{lra-lean}{LRA.VolumeIII.Analysis.Differentiation.GraphReading}{SmoothnessTower}{pending}
...
\input{volume-iii/book-analysis-ii/differentiation/notes/graph-reading/figure-lipschitz-derivative}
...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:class-c11}{lra-lean}{LRA.VolumeIII.Analysis.Differentiation.GraphReading}{IsClassC11}{pending}
...
\begin{aligned}
  ...
  f\in C^{1,1}(I)
  \Longleftrightarrow
  \operatorname{IsClassC}(f,1,I)\land
  \exists L\geq0:\operatorname{IsLipschitz}(f',I,\mathbb{R},\mathbb{R},L).
\end{aligned}
\]
...
\begin{description}
  \item[Exposition.]
  The class condition fails if the function is not class C1 or if the derivative is not Lipschitz.

  \item[\(\operatorname{IsLipschitz}.\)]
  The displayed obstruction is the predicate-level failure condition.
  \[
  \neg\operatorname{IsClassC}(f,1,I)\;\lor\;\neg\operatorname{IsLipschitz}(f',I,\mathbb{R},\mathbb{R},L).
  \]
  \[
  \neg\,\operatorname{IsLipschitz}(f',I,\mathbb{R},\mathbb{R},L).
  \]
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:c11-placement}{lra-lean}{LRA.VolumeIII.Analysis.Differentiation.GraphReading}{C11Placement}{pending}
...
\input{volume-iii/book-analysis-ii/differentiation/notes/graph-reading/figure-c11-descent-bounds}
...
\end{corollary}
\end{corollarybox}
\LeanFormalizes{cor:bounded-second-derivative-implies-c11}{lra-lean}{LRA.VolumeIII.Analysis.Differentiation.GraphReading}{BoundedSecondDerivativeImpliesC11}{pending}

\begin{remark*}[Standard quantified statement]
\[
  \bigl(f\in C^2(I)\land \forall x\in I:\ |f''(x)|\leq M\bigr)
  \Rightarrow
  f\in C^{1,1}(I)\land \operatorname{IsLipschitz}(f',I,\mathbb{R},\mathbb{R},M).
\]
\end{remark*}
