...
\input{volume-iii/book-analysis-ii/differentiation/notes/derivative-geometry/figure-concavity-convexity}
...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:convex-function}{lra-lean}{LRA.VolumeIII.Analysis.Differentiation.DerivativeGeometry}{IsConvexOn}{pending}
...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:concave-function}{lra-lean}{LRA.VolumeIII.Analysis.Differentiation.DerivativeGeometry}{IsConcaveOn}{pending}
...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:inflection-point}{lra-lean}{LRA.VolumeIII.Analysis.Differentiation.DerivativeGeometry}{IsInflection}{pending}
