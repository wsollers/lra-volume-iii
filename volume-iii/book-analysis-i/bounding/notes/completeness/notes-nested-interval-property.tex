...
\Longrightarrow
\operatorname{OrderPreserving}(a_n).
\]
\end{remark*}
...
\begin{remark*}[Negation predicate reading]
\[
\neg\operatorname{OrderPreserving}(a_n)
\Longrightarrow
...
\operatorname{NestedClosedIntervals}([a_n,b_n])
\Longrightarrow
\operatorname{OrderReversing}(b_n).
\]
\end{remark*}
...
\begin{remark*}[Negation predicate reading]
\[
\neg\operatorname{OrderReversing}(b_n)
\Longrightarrow
\neg\operatorname{NestedClosedIntervals}([a_n,b_n]).
\]
\end{remark*}
...
\operatorname{NestedClosedIntervals}([a_n,b_n])
\land
\operatorname{LeastUpperBound}(\alpha,\{a_n:n\in\mathbb{N}\})
\land
\operatorname{GreatestLowerBound}(\beta,\{b_n:n\in\mathbb{N}\})
\Longrightarrow
\alpha\le \beta.
\]
\end{remark*}
...
\neg\operatorname{NestedClosedIntervals}([a_n,b_n])
\lor
\neg\operatorname{LeastUpperBound}(\alpha,\{a_n:n\in\mathbb{N}\})
\lor
\neg\operatorname{GreatestLowerBound}(\beta,\{b_n:n\in\mathbb{N}\}).
\]
\end{remark*}
...
\operatorname{IsNonempty}\!\left(\bigcap_{n=1}^{\infty}I_n\right).
\]
\end{remark*}
...
\operatorname{NestedClosedBoundedIntervals}([a_n,b_n])
\land
\operatorname{ConvergesTo}((b_n-a_n),0,\mathbb{R})
\Longrightarrow
...
\neg\operatorname{NestedClosedBoundedIntervals}([a_n,b_n])
\lor
\neg\operatorname{ConvergesTo}((b_n-a_n),0,\mathbb{R}).
\]
\end{remark*}
...
\operatorname{ConvergesTo}((b_n-a_n),0,\mathbb{R})
\Longrightarrow
\operatorname{ConvergesTo}(a_n,x,\mathbb{R})
\land
\operatorname{ConvergesTo}(b_n,x,\mathbb{R}).
\]
\end{remark*}
...
\begin{remark*}[Predicate reading]
\[
\exists I_n\;\exists\mathcal{I}\;\bigl(
...
\land
\operatorname{IsEmpty}\!\left(\bigcap_{n=1}^{\infty}I_n\right)
\bigr).
\]
\end{remark*}
