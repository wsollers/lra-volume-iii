...
\[
\operatorname{SetSum}(A,B)=A+B,\quad
\operatorname{SetDifference}(A,B)=A-B,\quad
\operatorname{SetProduct}(A,B)=AB,\quad
\operatorname{SetQuotient}(A,B)=A/B.
\]
\end{remark*}
...
\[
\neg\operatorname{SetProduct}(A,B)=C
\quad\text{means}\quad
...
\begin{remark*}[Definition predicate reading]
\[
\operatorname{ReciprocalImage}(A)=A^{-1}.
\]
\end{remark*}
...
\begin{remark*}[Negation predicate reading]
\[
\neg\operatorname{ReciprocalImage}(A)=B
\quad\text{means}\quad
...
\begin{remark*}[Negation predicate reading]
\[
\operatorname{Infimum}(t,A)\land\neg\operatorname{Infimum}(t+c,A+c).
\]
\end{remark*}
...
\Longrightarrow
\operatorname{Infimum}(t_A+t_B,A+B).
\]
\end{remark*}
...
\neg\operatorname{Infimum}(t_A+t_B,A+B).
\]
\end{remark*}
...
\begin{remark*}[Predicate reading]
\[
\operatorname{Infimum}(t,A)\land\operatorname{Supremum}(s,B)
\Longrightarrow
\operatorname{Infimum}(t-s,A-B).
\]
\end{remark*}
...
\begin{remark*}[Negation predicate reading]
\[
\operatorname{Infimum}(t,A)\land\operatorname{Supremum}(s,B)\land
\neg\operatorname{Infimum}(t-s,A-B).
\]
\end{remark*}
...
\begin{remark*}[Predicate reading]
\[
\operatorname{Infimum}(m,A)\land\operatorname{Supremum}(M,A)\land
0\notin[m,M]
\Longrightarrow
\operatorname{Supremum}(m^{-1},A^{-1}).
\]
\end{remark*}
...
\begin{remark*}[Negation predicate reading]
\[
\operatorname{Infimum}(m,A)\land 0\notin[m,\sup A]\land
\neg\operatorname{Supremum}(m^{-1},A^{-1})
\]
...
\begin{remark*}[Negation predicate reading]
\[
\operatorname{Supremum}(M,A)\land 0\notin[\inf A,M]\land
\neg\operatorname{Infimum}(M^{-1},A^{-1})
\]
is contradictory under the stated hypotheses.
\end{remark*}
...
\begin{remark*}[Predicate reading]
\[
\operatorname{Infimum}(\alpha,A)\land\operatorname{Supremum}(\beta,A)\land
\operatorname{Infimum}(\gamma,B)\land\operatorname{Supremum}(\delta,B)
\Longrightarrow
\operatorname{Supremum}(\max\{\alpha\gamma,\alpha\delta,\beta\gamma,\beta\delta\},AB).
\]
\end{remark*}
...
\operatorname{Infimum}(\gamma,B)\land\operatorname{Supremum}(\delta,B)
\Longrightarrow
\operatorname{Infimum}(\min\{\alpha\gamma,\alpha\delta,\beta\gamma,\beta\delta\},AB).
\]
\end{remark*}
...
\begin{remark*}[Negation predicate reading]
\[
\neg\operatorname{Supremum}(\text{endpoint quotient maximum},A/B).
\]
\end{remark*}
...
\begin{remark*}[Negation predicate reading]
\[
\neg\operatorname{Infimum}(\text{endpoint quotient minimum},A/B).
\]
\end{remark*}
