...
% ============================================================
%  \S{}1  Manipulating Inequalities and the Logic of Bounding
%  volume-iii/book-analysis-i/real-analysis/notes/proof-techniques/
%  inequalities-bounding.tex
% ============================================================

\subsection{Manipulating Inequalities and the Logic of Bounding}
\label{sec:inequality-bounding}

\begin{toolkitbox}{Inequality Toolkit --- Quick Reference}
\small
\begin{tabular}{l l l}
\toprule
...
\end{enumerate}
\hyperref[prf:order-arithmetic]{Go to proof.}
\end{proposition}
\LeanFormalizes{prop:order-arithmetic}{lra-lean}{LRA.VolumeIII.Analysis.RealAnalysis.InequalitiesBoundingToolkit}{OrderArithmetic}{pending}
...
\input{volume-iii/book-analysis-i/real-analysis/notes/proof-techniques/figure-absolute-value-interval}

% -- \S{}1.3: Triangle inequality --------------------------------
...
\input{volume-iii/book-analysis-i/real-analysis/notes/proof-techniques/figure-triangle-inequality-pivot}

% -- \S{}1.4: Bounding is not solving ----------------------------
...
% -- \S{}1.5: $\varepsilon$-budget split -------------------------------------
\subsection*{\texorpdfstring{The $\varepsilon$-Budget Split}{The epsilon-Budget Split}}
...
\input{volume-iii/book-analysis-i/real-analysis/notes/proof-techniques/figure-epsilon-budget-split}

% -- \S{}1.6: Boundedness replacement ----------------------------
...
$n\in\mathbb{N}$.
\hyperref[prf:convergent-bounded]{Go to proof.}
\end{proposition}
...
% -- \S{}1.7: Work-backwards principle ---------------------------
...
% -- \S{}1.9: The +1 trick ---------------------------------------
\subsection*{\texorpdfstring{The $+1$ Trick for Denominators}{The +1 Trick for Denominators}}
...
% -- \S{}1.10: Summary table -------------------------------------
\subsection*{Summary: The Bounding Mindset}
