...
\begin{dependencies}
\hyperref[def:absolute-value]{Absolute value},
\hyperref[thm:ring-double-negation]{double negation}.
\end{dependencies}
...
\begin{dependencies}
\hyperref[def:absolute-value]{Absolute value},
\hyperref[thm:ring-negation-of-product]{negation of product},
\hyperref[thm:ring-product-of-negatives]{product of negatives},
\hyperref[thm:ordered-field-squares-nonnegative]{squares are nonnegative}.
\end{dependencies}
