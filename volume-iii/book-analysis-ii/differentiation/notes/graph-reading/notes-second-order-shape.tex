...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:second-derivative}{lra-lean}{LRA.VolumeIII.Analysis.Differentiation.GraphReading}{SecondDerivative}{pending}
...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:higher-derivatives}{lra-lean}{LRA.VolumeIII.Analysis.Differentiation.ChainRule}{NthDerivativeAt}{pending}
\LeanFormalizes{def:higher-derivatives}{lra-lean}{LRA.VolumeIII.Analysis.Differentiation.GraphReading}{HigherDerivativeAt}{pending}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:second-derivative-convexity-test}{lra-lean}{LRA.VolumeIII.Analysis.Differentiation.GraphReading}{SecondDerivativeConvexityTest}{pending}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:second-derivative-concavity-test}{lra-lean}{LRA.VolumeIII.Analysis.Differentiation.GraphReading}{SecondDerivativeConcavityTest}{pending}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:second-derivative-test}{lra-lean}{LRA.VolumeIII.Analysis.Differentiation.GraphReading}{SecondDerivativeTest}{pending}
...
\end{proposition}
\end{propositionbox}
\LeanFormalizes{prop:inflection-point-necessary-condition}{lra-lean}{LRA.VolumeIII.Analysis.Differentiation.GraphReading}{InflectionPointNecessaryCondition}{pending}
