...
\begin{bpnew}{thmborder}{Theorem: Limit Preserves Eventual Order}
% ---------------------------------------------------------
...
\begin{bpnew}{thmborder}{Theorem: Strict Limit Separation Gives Eventual Order}
% ---------------------------------------------------------
...
\begin{bpnew}{thmborder}{Theorem: Eventual Strict Comparison Preserves Weak Limit Order}
% ---------------------------------------------------------
...
\begin{bpnew}{thmborder}{Theorem: Constant Comparison for Sequence Limits}
% ---------------------------------------------------------
...
\begin{bpnew}{thmborder}{Theorem: Constant Squeeze Theorem}
% ---------------------------------------------------------
...
\begin{bpnew}{thmborder}{Theorem: Sequence Squeeze Theorem}
% ---------------------------------------------------------
...
\begin{bpnew}{thmborder}{Theorem: Absolute-Value Squeeze Theorem}
% ---------------------------------------------------------
