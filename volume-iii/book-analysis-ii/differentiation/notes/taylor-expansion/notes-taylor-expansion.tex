...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:taylor-theorem-lagrange-remainder}{lra-lean}{LRA.VolumeIII.Analysis.Differentiation.TaylorExpansion}{TaylorTheoremLagrangeRemainder}{pending}
...
\end{corollary}
\end{corollarybox}
\LeanFormalizes{cor:taylor-expansion-peano-remainder}{lra-lean}{LRA.VolumeIII.Analysis.Differentiation.TaylorExpansion}{TaylorExpansionPeanoRemainder}{pending}
...
\end{corollary}
\end{corollarybox}
\LeanFormalizes{cor:first-order-peano-remainder}{lra-lean}{LRA.VolumeIII.Analysis.Differentiation.TaylorExpansion}{FirstOrderPeanoRemainder}{pending}
...
% Lean-aligned addition: thm:flat-function-properties
\begin{theorem}[Flat Function Properties]
\label{thm:flat-function-properties}
The smooth function that is $0$ at the origin and agrees with $e^{-1/x^2}$ away from the origin has all derivatives equal to $0$ at the origin, but is not identically zero on any neighborhood of the origin.

\smallskip
\noindent
\hyperref[prf:flat-function-properties]{\textit{Go to proof.}}
\end{theorem}
\LeanFormalizes{thm:flat-function-properties}{lra-lean}{LRA.VolumeIII.Analysis.Differentiation.TaylorExpansion}{FlatFunctionProperties}{pending}
