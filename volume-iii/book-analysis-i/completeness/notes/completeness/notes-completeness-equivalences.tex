...
% =========================================================
% Lean mapping note:
% StandardCompletenessEquivalences.
...
\begin{remark*}[Interpretation]
The first two statements are order versions. The third is the monotone-process
or monotone-sequence version. The fourth is the interval version. The fifth is
the Cauchy version. The sixth is the compactness version for bounded
sequences.
\end{remark*}
...
% Lean-aligned addition: def:increasing-bounded-sequences-converge
\begin{definition}[Increasing Bounded Sequence Convergence Property]
\label{def:increasing-bounded-sequences-converge}
An ordered topological field $F$ has the \emph{increasing bounded sequence convergence property} if every increasing sequence in $F$ that is bounded above converges to a point of $F$.
\end{definition}
...
\NoLocalDependencies
\end{dependencies}
% Lean-aligned addition: def:decreasing-bounded-sequences-converge
\begin{definition}[Decreasing Bounded Sequence Convergence Property]
\label{def:decreasing-bounded-sequences-converge}
An ordered topological field $F$ has the \emph{decreasing bounded sequence convergence property} if every decreasing sequence in $F$ that is bounded below converges to a point of $F$.
\end{definition}
...
\NoLocalDependencies
\end{dependencies}
% Lean-aligned addition: def:cauchy-sequences-converge
\begin{definition}[Cauchy Sequence Convergence Property]
\label{def:cauchy-sequences-converge}
A uniform topological field $F$ has the \emph{Cauchy sequence convergence property} if every Cauchy sequence $(a_n)$ in $F$ converges to some limit $L\in F$.
\end{definition}
\LeanFormalizes{def:cauchy-sequences-converge}{lra-lean}{LRA.VolumeIII.Analysis.Completeness.CompletenessEquivalences}{CauchySequencesConverge}{pending}
...
\NoLocalDependencies
\end{dependencies}
% Lean-aligned addition: def:bolzano-weierstrass-property
\begin{definition}[Bolzano--Weierstrass Property]
\label{def:bolzano-weierstrass-property}
An ordered topological field $F$ has the \emph{Bolzano--Weierstrass property} if every bounded sequence in $F$ has a strictly increasing subsequence converging to a point of $F$.
\end{definition}
\LeanFormalizes{def:bolzano-weierstrass-property}{lra-lean}{LRA.VolumeIII.Analysis.Completeness.CompletenessEquivalences}{BolzanoWeierstrassProperty}{pending}
