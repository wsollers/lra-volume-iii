...
\end{proposition}
\LeanFormalizes{prop:boundedness-is-necessary-in-nested-interval-theorem}{lra-lean}{LRA.VolumeIII.Analysis.Completeness.NestedIntervalProperty}{BoundednessIsNecessaryInNestedIntervalTheorem}{pending}
