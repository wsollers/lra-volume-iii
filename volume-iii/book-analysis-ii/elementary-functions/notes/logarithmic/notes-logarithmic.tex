...
\begin{remark*}[Predicate reading]
\[
  \operatorname{TendsTo}\!\left(\frac{\ln(1+x)}{x},\,0,\,1\right)
  \;\colonequiv\;
  ...
  \bigl(
    ...
    \wedge
    \operatorname{Within}\!\left(\frac{\ln(1+x)}{x},B_\varepsilon(1),\mathbb R\right)
  \bigr).
\]
\end{remark*}
...
\[
  ...
  \bigl(
    ...
    \wedge
    \operatorname{Within}(x^{-r}\ln x,B_\varepsilon(0),\mathbb R)
  \bigr).
\]
\end{remark*}
