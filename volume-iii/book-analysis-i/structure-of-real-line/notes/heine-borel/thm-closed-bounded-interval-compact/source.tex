...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:closed-bounded-interval-compact}{lra-lean}{LRA.VolumeIII.Analysis.StructureOfRealLine.Compactness}{ClosedBoundedIntervalCompact}{pending}
\LeanFormalizes{thm:closed-bounded-interval-compact}{lra-lean}{LRA.VolumeIII.Analysis.StructureOfRealLine.CompactnessAdditions}{ClosedSubsetOfCompactIsCompact}{pending}
