...
\end{corollary}
\end{corollarybox}
\LeanFormalizes{cor:bounded-set-has-supremum-and-infimum}{lra-lean}{LRA.VolumeIII.Analysis.Bounding.ExtremalBounds.SupremaInfima}{BoundedSetHasSupremumAndInfimum}{pending}
