...
\end{theorem}
\LeanFormalizes{thm:infimum-is-monotone-under-inclusion}{lra-lean}{LRA.VolumeIII.Analysis.Bounding.ExtremalBounds.SupremaInfima}{InfimumAntitoneUnderInclusion}{pending}
