...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:divergent-sequence}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Divergence}{IsDivergent}{pending}
...
\[
\operatorname{IsDivergent}(x_n,\mathbb{R})
\coloneqq
\forall L\in\mathbb{R}\;\exists \varepsilon>0\;\forall N\in\mathbb{N}
\;\exists n\ge N\;\bigl(|x_n-L|\ge\varepsilon\bigr).
\]
...
\[
\neg\operatorname{IsDivergent}(x_n,\mathbb{R})
\Longleftrightarrow
...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:diverges-to-positive-infinity}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Divergence}{DivergesToPosInf}{pending}
...
\begin{description}
  \item[Exposition.]
Failure is witnessed by one real threshold that is reached or crossed
infinitely often from below.
  \item[\(\operatorname{DivergesToPositiveInfinity}.\)]
\[
x_n\not\to+\infty
\Longleftrightarrow
\exists M\in\mathbb{R}\;\forall N\in\mathbb{N}\;\exists n\ge N
...
\]
\[
\neg\operatorname{DivergesToPositiveInfinity}(x_n,\mathbb{R})
\Longleftrightarrow
\exists M\in\mathbb{R}\;\forall N\in\mathbb{N}\;\exists n\ge N
\;\bigl(x_n\le M\bigr).
\]
...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:diverges-to-negative-infinity}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Divergence}{DivergesToNegInf}{pending}
...
\begin{description}
  \item[Exposition.]
Failure is witnessed by one real threshold that is reached or crossed
infinitely often from above.
  \item[\(\operatorname{DivergesToNegativeInfinity}.\)]
\[
x_n\not\to-\infty
\Longleftrightarrow
\exists M\in\mathbb{R}\;\forall N\in\mathbb{N}\;\exists n\ge N
...
\]
\[
\neg\operatorname{DivergesToNegativeInfinity}(x_n,\mathbb{R})
\Longleftrightarrow
\exists M\in\mathbb{R}\;\forall N\in\mathbb{N}\;\exists n\ge N
\;\bigl(M\le x_n\bigr).
\]
...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:oscillatory-sequence}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Divergence}{IsOscillatory}{pending}
...
\[
\begin{aligned}
\operatorname{IsOscillatory}(x_n,\mathbb{R})
\coloneqq\;&
\operatorname{IsDivergent}(x_n,\mathbb{R})\\
&\land\;\neg\operatorname{DivergesToPositiveInfinity}(x_n,\mathbb{R})\\
&\land\;\neg\operatorname{DivergesToNegativeInfinity}(x_n,\mathbb{R}).
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:divergence-to-infinity-implies-real-divergence}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Divergence}{DivergenceToInfinityImpliesRealDivergence}{pending}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:two-subsequential-limits-force-divergence}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Divergence}{TwoSubsequentialLimitsForceDivergence}{pending}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:unbounded-above-has-positive-infinity-subsequence}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Divergence}{UnboundedAboveHasPositiveInfinitySubsequence}{pending}
...
\bigl(
  ...
  Q=\mathsf{OrderedSet}(\mathbb{N},\leq),\\
  \operatorname{StrictOrderPreserving}(\sigma,P,Q)
  \land
  \operatorname{DivergesToPositiveInfinity}(x_{\sigma(k)},\mathbb{R})
\bigr).
\]
\end{remark*}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:unbounded-below-has-negative-infinity-subsequence}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Divergence}{UnboundedBelowHasNegativeInfinitySubsequence}{pending}
...
\bigl(
  ...
  \operatorname{StrictOrderPreserving}(\sigma,P,Q)
  \land
  \operatorname{DivergesToNegativeInfinity}(x_{\sigma(k)},\mathbb{R})
\bigr).
\]
\end{remark*}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:bounded-divergence-produces-two-subsequential-limits}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Divergence}{BoundedDivergenceProducesTwoSubsequentialLimits}{pending}
