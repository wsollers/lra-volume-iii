...
\operatorname{IsCauchy}(x_n)
\Longrightarrow
\operatorname{IsNull}\bigl(|x_{n+1}-x_n|\bigr).
\]
\end{remark*}
...
\operatorname{IsCauchy}(x_n)
\Longrightarrow
\operatorname{IsCauchy}(\alpha x_n).
\]
\end{remark*}
...
\operatorname{IsCauchy}(x_n)
\land
\operatorname{IsCauchy}(y_n)
\Longrightarrow
\operatorname{IsCauchy}(x_n+y_n).
\]
\end{remark*}
...
\operatorname{IsCauchy}(y_n)
\Longrightarrow
\operatorname{IsCauchy}(\alpha x_n+\beta y_n).
\]
\end{remark*}
