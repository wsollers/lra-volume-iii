...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:real-line-structural-order-facts}{lra-lean}{LRA.VolumeIII.Analysis.StructureOfRealLine.OrderDistanceIntervals}{RealLineStructuralOrderFacts}{pending}
