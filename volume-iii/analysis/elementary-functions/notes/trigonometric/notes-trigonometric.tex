...
\begin{dependencies}
\begin{itemize}
  \item TODO: determine dependencies for \texttt{def:sine-cosine}.
\end{itemize}
\end{dependencies}
...
\begin{dependencies}
\begin{itemize}
  \item TODO: determine dependencies for \texttt{prop:pythagorean-identity}.
\end{itemize}
\end{dependencies}
...
\begin{dependencies}
\begin{itemize}
  \item TODO: determine dependencies for \texttt{prop:trig-addition-formulas}.
\end{itemize}
\end{dependencies}
...
\begin{dependencies}
\begin{itemize}
  \item TODO: determine dependencies for \texttt{def:other-trig}.
\end{itemize}
\end{dependencies}
...
\begin{dependencies}
\begin{itemize}
  \item TODO: determine dependencies for \texttt{def:inverse-trig}.
\end{itemize}
\end{dependencies}
...
\begin{dependencies}
\begin{itemize}
  \item TODO: determine dependencies for \texttt{thm:fundamental-trig-limit}.
\end{itemize}
\end{dependencies}
...
\begin{dependencies}
\begin{itemize}
  \item TODO: determine dependencies for \texttt{prop:limit-one-minus-cos}.
\end{itemize}
\end{dependencies}
