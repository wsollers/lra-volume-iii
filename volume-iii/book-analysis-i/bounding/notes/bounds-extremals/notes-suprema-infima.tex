...
\label{def:supremum}
Let $A\subseteq\mathbb{R}$ be nonempty and let $s\in\mathbb{R}$.  The
element $s$ is the \emph{supremum} of $A$, written $s=\sup A$, if $s$ is an
upper bound of $A$ and $s$ is less than or equal to every upper bound of
$A$.
\end{definition}
\end{definitionbox}
...
\begin{itemize}
  ...
  \item \hyperref[def:is-nonempty]{Nonempty}
\end{itemize}
\end{dependencies}
...
\label{def:infimum}
Let $A\subseteq\mathbb{R}$ be nonempty and let $i\in\mathbb{R}$.  The
element $i$ is the \emph{infimum} of $A$, written $i=\inf A$, if $i$ is a
lower bound of $A$ and every lower bound of $A$ is less than or equal to
$i$.
\end{definition}
\end{definitionbox}
...
Let $A\subseteq B\subseteq S$ be subsets of an ordered set $(S,\leq)$.  If
$u$ is an upper bound of $B$, then $u$ is an upper bound of $A$.
...
\begin{description}
  ...
  \item[\operatorname{UpperBound} / \operatorname{GreatestLowerBound}.]
...
Let $A\subseteq B\subseteq S$ be subsets of an ordered set $(S,\leq)$.  If
$\ell$ is a lower bound of $B$, then $\ell$ is a lower bound of $A$.
...
\begin{description}
  ...
  \item[\operatorname{LowerBound} / \operatorname{GreatestLowerBound}.]
...
Let $A,B\subseteq\mathbb{R}$ be nonempty subsets whose suprema exist.  If
every $a\in A$ is below some $b\in B$, then $\sup A\leq\sup B$.
...
exists a real number $i$ such that $i=\inf S$; equivalently, every
nonempty bounded-below subset of $\mathbb{R}$ has an infimum in
$\mathbb{R}$.
