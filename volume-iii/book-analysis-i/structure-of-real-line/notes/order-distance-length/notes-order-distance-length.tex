...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:distance-on-real-line}{lra-lean}{LRA.VolumeIII.Analysis.StructureOfRealLine.OrderDistanceIntervals}{dist}{pending}
...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:length-of-interval}{lra-lean}{LRA.VolumeIII.Analysis.StructureOfRealLine.OrderDistanceIntervals}{IntervalLength}{pending}
\begin{remark*}[Standard quantified statement]
\[
