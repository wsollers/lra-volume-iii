...
\begin{remark*}[Predicate reading]
\[
  A\subseteq B\land\operatorname{UpperBound}(u,B,P)
...
\begin{remark*}[Predicate reading]
\[
  A\subseteq B\land\operatorname{LowerBound}(\ell,B,P)
...
\[
  P=\mathsf{OrderedSet}(\mathbb{R},\leq),\qquad
  (\exists A)(\exists s)\bigl(\operatorname{LeastUpperBound}(s,A,P)\land s\notin A\bigr).
\]
\end{remark*}
...
\[
  P=\mathsf{OrderedSet}(\mathbb{R},\leq),\qquad
  (\exists A)(\exists i)\bigl(\operatorname{GreatestLowerBound}(i,A,P)\land i\notin A\bigr).
\]
\end{remark*}
