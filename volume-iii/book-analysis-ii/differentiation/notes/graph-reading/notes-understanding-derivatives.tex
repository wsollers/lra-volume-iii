...
\begin{remark*}[Standard quantified statement]
\[
\forall x \in (a,b)\;\operatorname{Derivative}(f,x,0)
\;\Rightarrow\;
...
\;\Rightarrow\;
\exists x \in (a,b)\;\lnot\operatorname{Derivative}(f,x,0).
\]
...
\begin{remark*}[Standard quantified statement]
\[
\operatorname{Derivative}(f,c,L) \;\land\; L > 0
\;\Rightarrow\;
...
&\quad\Rightarrow\; \operatorname{IsLocalMaximum}(f,c).
\end{align*}
\end{remark*}
...
&\quad\Rightarrow\; \operatorname{IsLocalMinimum}(f,c).
\end{align*}
\end{remark*}
