...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:closed-set-closure-operations}{lra-lean}{LRA.VolumeIII.Analysis.StructureOfRealLine.OpenClosedSets}{ClosedSetClosureOperations}{pending}
