...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:inverse-function-theorem-one-variable}{lra-lean}{LRA.VolumeIII.Analysis.Differentiation.AlgebraOfDerivatives}{InverseFunctionTheoremOneVariable}{pending}
...
\end{itemize}
  ...
  \item[\(\operatorname{IsDifferentiable}.\)]
  ...
  \]
  \[
  \neg\,\operatorname{IsDifferentiable}(f,a,\mathbb{R},\mathbb{R}).
  \]
\end{description}
\end{remark*}
...
\end{corollary}
\end{corollarybox}
\LeanFormalizes{cor:inverse-function-derivative}{lra-lean}{LRA.VolumeIII.Analysis.Differentiation.AlgebraOfDerivatives}{InverseFunctionDerivative}{pending}
