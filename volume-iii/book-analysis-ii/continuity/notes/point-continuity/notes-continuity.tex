...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:relative-neighborhood}{lra-lean}{LRA.VolumeIII.Analysis.Continuity.PointContinuity}{RelativeNeighborhood}{pending}
...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:continuous-at-point}{lra-lean}{LRA.VolumeIII.Analysis.Continuity.PointContinuity}{ContinuousAtPoint}{pending}
...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:continuous-at-point-nbhd}{lra-lean}{LRA.VolumeIII.Analysis.Continuity.PointContinuity}{ContinuousAtPointNbhd}{pending}
...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:continuous-at-point-seq}{lra-lean}{LRA.VolumeIII.Analysis.Continuity.PointContinuity}{ContinuousAtPointSeq}{pending}
...
% Lean-aligned addition: thm:continuous-at-point-iff-nbhd
\begin{theorem}[Continuity at a Point via Neighborhoods]
\label{thm:continuous-at-point-iff-nbhd}
A function is continuous at $c$ if and only if for every neighborhood $V$ of $f(c)$ there is a neighborhood $U$ of $c$ such that $x\in U\cap A$ implies $f(x)\in V$.

\smallskip
\noindent
\hyperref[prf:continuous-at-point-iff-nbhd]{\textit{Go to proof.}}
\end{theorem}
\LeanFormalizes{thm:continuous-at-point-iff-nbhd}{lra-lean}{LRA.VolumeIII.Analysis.Continuity.PointContinuity}{ContinuousAtPointIffNbhd}{pending}
...
\NoLocalDependencies
\end{dependencies}
% Lean-aligned addition: thm:continuous-at-point-iff-seq
\begin{theorem}[Continuity at a Point via Sequences]
\label{thm:continuous-at-point-iff-seq}
A function is continuous at $c$ if and only if every sequence in the domain converging to $c$ has image sequence converging to $f(c)$.

\smallskip
\noindent
\hyperref[prf:continuous-at-point-iff-seq]{\textit{Go to proof.}}
\end{theorem}
\LeanFormalizes{thm:continuous-at-point-iff-seq}{lra-lean}{LRA.VolumeIII.Analysis.Continuity.PointContinuity}{ContinuousAtPointIffSeq}{pending}
