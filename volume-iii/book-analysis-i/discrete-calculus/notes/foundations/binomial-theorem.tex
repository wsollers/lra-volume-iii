...
\frac{n!}{k!(n-k)!}.
\]
\hyperref[prf:binomial-theorem]{\textit{Go to proof.}}
\end{theorem}
...
\[
  n\in\mathbb{N},\quad x,y\in\mathbb{R}
...
The theorem 
expands a power of a sum by counting how many terms choose each
possible number of \(y\)-factors.
...
\begin{center}
\input{volume-iii/book-analysis-i/discrete-calculus/notes/foundations/figure-pascals-triangle}
\end{center}
...
f(x+k).
\]
\hyperref[prf:higher-diff-formula]{Go to proof.}
\end{proposition}
...
\begin{remark*}[Interpretation]
The \(n\)-th forward difference is a signed binomial combination of \(n+1\)
