...
% =========================================================
% Lean mapping note:
% NestedIntervalProperty, IsNestedClosedIntervalFamily,
...
\input{volume-iii/book-analysis-i/completeness/notes/completeness/figure-nested-interval-endpoints}
...
\end{corollary}
\end{corollarybox}
\LeanFormalizes{cor:nested-interval-intersection-contains-endpoint-supremum}{lra-lean}{LRA.VolumeIII.Analysis.Completeness.NestedIntervalProperty}{NestedIntervalIntersectionContainsEndpointSupremum}{pending}
...
\end{corollary}
\end{corollarybox}
\LeanFormalizes{cor:nested-interval-intersection-contains-endpoint-infimum}{lra-lean}{LRA.VolumeIII.Analysis.Completeness.NestedIntervalProperty}{NestedIntervalIntersectionContainsEndpointInfimum}{pending}
...
\end{corollary}
\end{corollarybox}
\LeanFormalizes{cor:unique-point-in-nested-intervals-is-endpoint-limit}{lra-lean}{LRA.VolumeIII.Analysis.Completeness.NestedIntervalProperty}{UniquePointInNestedIntervalsIsEndpointLimit}{pending}
...
\input{volume-iii/book-analysis-i/completeness/notes/completeness/figure-nested-interval-failures}
...
\input{volume-iii/book-analysis-i/completeness/notes/completeness/figure-nested-intervals}

% Lean-aligned additions inserted for Volume III Lean-to-TeX handoff.
% Lean-aligned addition: def:is-nested-closed-interval-family
\begin{definition}[Nested Closed Interval Family]
\label{def:is-nested-closed-interval-family}
A family $([a_n,b_n])_{n\in\mathbb N}$ is a \emph{nested closed interval family} if $a_n\le b_n$ for every $n$ and $[a_{n+1},b_{n+1}]\subseteq [a_n,b_n]$ for every $n$.
\end{definition}
\LeanFormalizes{def:is-nested-closed-interval-family}{lra-lean}{LRA.VolumeIII.Analysis.Completeness.NestedIntervalProperty}{IsNestedClosedIntervalFamily}{pending}
