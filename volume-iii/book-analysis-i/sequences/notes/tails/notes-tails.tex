...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:m-tail}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Tails}{MTail}{pending}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:convergence-of-tail}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Tails}{ConvergenceOfTail}{pending}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:convergence-by-domination}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Tails}{ConvergenceByDomination}{pending}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:ratio-limit-less-than-one-implies-null}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Tails}{RatioLimitLessThanOneImpliesNull}{pending}
