...
\[
\begin{aligned}
  \neg\,\operatorname{TendsTo}(f,A,c,L)
  &\Longleftrightarrow
  \exists \varepsilon_0\,
  \Bigl(
    \varepsilon_0>0
...
\[
  ...
  \;\colonequiv\;
  \forall (x_n) \subseteq A \setminus \{c\} :\;
  \operatorname{ConvergesTo}(x_n, c)
  \;\Rightarrow\;
  \operatorname{ConvergesTo}(f(x_n), L).
\]
\end{remark*}
...
\begin{remark*}[Interpretation]
The existence and value of $\operatorname{TendsTo}(f, x_0, L)$
