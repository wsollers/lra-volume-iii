...
\textbf{Theorem (Summation by Parts).}
...
\begin{proof}
By the Discrete Product Rule (Theorem~\ref{thm:discrete-product-rule}),
\[
...
(Theorem~\ref{thm:fundamental-theorem-finite-calculus}) to the first sum on the right gives
\[
