...
\[
\operatorname{HasLeastUpperBoundProperty}(S)\coloneqq
\forall A\subseteq S\;
\Bigl[
\bigl(A\neq\varnothing \land \exists u\in S\;\forall x\in A\;(x\le u)\bigr)
\rightarrow
...
\[
\neg\operatorname{HasLeastUpperBoundProperty}(S)\Longleftrightarrow
\exists A\subseteq S\;
\Bigl[
A\neq\varnothing
\land
...
\begin{remark*}[Negation predicate reading]
\[
\neg\operatorname{HasLeastUpperBoundProperty}(\mathbb{R})\Longleftrightarrow
\exists A\subseteq\mathbb{R}\;
\Bigl[
A\neq\varnothing
\land
