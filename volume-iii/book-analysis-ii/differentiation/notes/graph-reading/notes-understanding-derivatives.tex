...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:increasing-at-a-point}{lra-lean}{LRA.VolumeIII.Analysis.Differentiation.GraphReading}{IsIncreasingAt}{pending}
...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:decreasing-at-a-point}{lra-lean}{LRA.VolumeIII.Analysis.Differentiation.GraphReading}{IsDecreasingAt}{pending}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:zero-derivative-implies-constant}{lra-lean}{LRA.VolumeIII.Analysis.Differentiation.GraphReading}{ZeroDerivativeImpliesConstant}{pending}
...
\end{corollary}
\end{corollarybox}
\LeanFormalizes{cor:equal-derivatives-constant-difference}{lra-lean}{LRA.VolumeIII.Analysis.Differentiation.GraphReading}{EqualDerivativesConstantDifference}{pending}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:nondecreasing-iff-nonneg-derivative}{lra-lean}{LRA.VolumeIII.Analysis.Differentiation.MeanValueTheorem}{NondecreasingIffNonnegDerivative}{pending}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:nonincreasing-iff-nonpos-derivative}{lra-lean}{LRA.VolumeIII.Analysis.Differentiation.GraphReading}{NonincreasingIffNonposDerivative}{pending}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:first-derivative-test-maximum}{lra-lean}{LRA.VolumeIII.Analysis.Differentiation.GraphReading}{FirstDerivativeTestMaximum}{pending}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:first-derivative-test-minimum}{lra-lean}{LRA.VolumeIII.Analysis.Differentiation.GraphReading}{FirstDerivativeTestMinimum}{pending}
...
% Lean-aligned addition: def:order-reversing
\begin{definition}[Order-Reversing Function on a Set]
\label{def:order-reversing}
A function $f:A\to\mathbb R$ is \emph{order-reversing} on $A$ if $x,y\in A$ and $x\le y$ imply $f(y)\le f(x)$.
\end{definition}
\LeanFormalizes{def:order-reversing}{lra-lean}{LRA.VolumeIII.Analysis.Differentiation.GraphReading}{OrderReversing}{pending}
