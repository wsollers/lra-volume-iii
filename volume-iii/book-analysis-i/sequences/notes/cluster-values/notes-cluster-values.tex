...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:cluster-value-sequence}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.ClusterValues}{IsClusterValueOf}{pending}
...
\begin{description}
  \item[Exposition.]
Failure is witnessed by a tail that avoids one fixed neighborhood of $L$.
  \item[\(\operatorname{IsClusterValue}.\)]
\[
L\text{ is not a cluster value of }(x_n)
\Longleftrightarrow
\exists \varepsilon>0\;\exists N\in\mathbb{N}\;\forall n\ge N
...
\]
\[
\neg\operatorname{IsClusterValue}(x_n,L,\mathbb{R})
\Longleftrightarrow
\exists \varepsilon>0\;\exists N\in\mathbb{N}\;\forall n\ge N
\;\bigl(|x_n-L|\ge\varepsilon\bigr).
\]
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:cluster-values-are-subsequential-limits}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.ClusterValues}{ClusterValuesAreSubsequentialLimits}{pending}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:bounded-sequences-have-cluster-values}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.ClusterValues}{BoundedSequencesHaveClusterValues}{pending}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:limsup-liminf-extremal-cluster-values}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.ClusterValues}{LimsupLiminfExtremalClusterValues}{pending}
...
\Longrightarrow\\
&\quad
\operatorname{IsClusterValue}
\bigl(x_n,\limsup_{n\to\infty}x_n,\mathbb{R}\bigr)
\land
\forall L\in\mathbb{R}\;
\bigl(\operatorname{IsClusterValue}(x_n,L,\mathbb{R})
\Longrightarrow L\le \limsup_{n\to\infty}x_n\bigr),\\
&\operatorname{Bounded}(x_n,\mathbb{R})
\Longrightarrow\\
&\quad
\operatorname{IsClusterValue}
\bigl(x_n,\liminf_{n\to\infty}x_n,\mathbb{R}\bigr)
\land
\forall L\in\mathbb{R}\;
\bigl(\operatorname{IsClusterValue}(x_n,L,\mathbb{R})
\Longrightarrow \liminf_{n\to\infty}x_n\le L\bigr).
