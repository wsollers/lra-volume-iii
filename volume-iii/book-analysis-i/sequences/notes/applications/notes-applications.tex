...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:newton-approximation-sqrt-two}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Applications}{NewtonApproximationSqrtTwo}{pending}
...
\[
\operatorname{ConvergesTo}(x_n,\sqrt{2},\mathbb{R}).
\]
\end{remark*}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:factorial-partial-sums-approximate-e}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Applications}{FactorialPartialSumsApproximateE}{pending}
...
\begin{remark*}[Predicate reading]
\[
\operatorname{ConvergesTo}(s_n,e,\mathbb{R}).
\]
\end{remark*}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:compound-interest-approximation-e}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Applications}{CompoundInterestApproximationE}{pending}
...
\begin{remark*}[Predicate reading]
\[
\operatorname{ConvergesTo}(c_n,e,\mathbb{R}).
\]
\end{remark*}
...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:decimal-truncations-converge}{lra-lean}{LRA.VolumeIII.Analysis.Sequences.Applications}{DecimalTruncationsConverge}{pending}
...
\begin{remark*}[Predicate reading]
\[
\operatorname{ConvergesTo}(d_n,\alpha,\mathbb{R}).
\]
\end{remark*}
